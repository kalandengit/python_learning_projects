...
- `versionName` **1.8.2**, `versionCode` 10802 (see `app/build.gradle`).
...
2. uploads `nko-voice-transcriptor-1.8.2-debug.apk` as a workflow **artifact**, and
3. publishes it to a **prerelease** (`apk-v1.8.2`) for a direct download link.
