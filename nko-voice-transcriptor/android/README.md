...
- `versionName` **1.10.1**, `versionCode` 11001 (see `app/build.gradle`).
...
2. uploads `nko-voice-transcriptor-1.10.1-debug.apk` as a workflow **artifact**, and
3. publishes it to a **prerelease** (`apk-v1.10.1`) for a direct download link.
