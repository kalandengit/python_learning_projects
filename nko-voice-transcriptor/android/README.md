...
- `versionName` **1.8.0**, `versionCode` 10800 (see `app/build.gradle`).
...
2. uploads `nko-voice-transcriptor-1.8.0-debug.apk` as a workflow **artifact**, and
3. publishes it to a **prerelease** (`apk-v1.8.0`) for a direct download link.
