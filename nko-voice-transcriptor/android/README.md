...
- `versionName` **1.10.0**, `versionCode` 11000 (see `app/build.gradle`).
...
2. uploads `nko-voice-transcriptor-1.10.0-debug.apk` as a workflow **artifact**, and
3. publishes it to a **prerelease** (`apk-v1.10.0`) for a direct download link.
