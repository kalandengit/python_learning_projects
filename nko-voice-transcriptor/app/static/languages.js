...
window.NKO_LANGUAGE_PACK = {
  fr: {
    ...
    edit_result: "✎ Modifier le résultat", editing: "modification…", save_edit: "💾 Enregistrer", copy_nko: "⧉ Copier le N'Ko", copy_latin: "⧉ Copier le latin",
  ...
  bm: {
    ...
    edit_result: "✎ Jaabi ladilan", editing: "ladilanni…", save_edit: "💾 A mara", copy_nko: "⧉ N'Ko sɛbɛn kopi", copy_latin: "⧉ Latɛnkanna kopi",
  ...
  en: {
    ...
    edit_result: "✎ Edit result", editing: "editing…", save_edit: "💾 Save edit", copy_nko: "⧉ Copy N'Ko", copy_latin: "⧉ Copy Latin", copied: "✓ Copied", copy_blocked: "✗ Copy blocked",
  ...
  ru: {
    ...
    or_upload: "…или загрузите аудиофайл:", nko: "N'Ko", editable_hint: "— можно редактировать", latin: "Латиница (манден)", edit_result: "✎ Изменить результат", editing: "редактирование…", save_edit: "💾 Сохранить",
  ...
  zh: {
    ...
    nko: "N'Ko", editable_hint: "— 可编辑，点击修正", latin: "拉丁字母（曼丁语）", edit_result: "✎ 编辑结果", editing: "正在编辑…", save_edit: "💾 保存修改", copy_nko: "⧉ 复制 N'Ko", copy_latin: "⧉ 复制拉丁文字",
  ...
  ar: {
    ...
    or_upload: "…أو ارفع ملفًا صوتيًا:", nko: "النكو", editable_hint: "— قابل للتعديل، انقر للتصحيح", latin: "اللاتينية (ماندينغ)", edit_result: "✎ تعديل النتيجة", editing: "جارٍ التعديل…", save_edit: "💾 حفظ التعديل",
  ...
  nqo: {
    ...
    or_upload: "…ߥߟߊ߫ ߞߊ߲ ߞߐߕߐ߮ ߟߊߦߟߍ߬:", nko: "ߒߞߏ", editable_hint: "— ߊ߬ ߘߌ߫ ߛߋ߫ ߟߊߛߊ߬ߦߌ߬ ߟߊ߫", latin: "ߟߊߕߍ߲ (ߡߊ߲ߘߋ߲)", edit_result: "✎ ߖߊ߬ߓߌ ߟߊߛߊ߬ߦߌ߬", editing: "ߟߊߛߊ߬ߦߌ߬ߟߌ…", save_edit: "💾 ߊ߬ ߟߊߡߊߙߊ߫",
