...
OAUTH_BASE_URL="${OAUTH_BASE_URL:-}"    # public HTTPS origin, defaults from DOMAIN
...
SECURE_COOKIES=0
[ "$ENABLE_TLS" = "1" ] && SECURE_COOKIES=1
[ -n "$OAUTH_BASE_URL" ] || OAUTH_BASE_URL="${CORS_ORIGINS}"
...
NKO_JOB_DATA_DIR=${APP_HOME}/job-data
NKO_SECURE_COOKIES=${SECURE_COOKIES}
NKO_LLM_PROVIDER=${LLM_PROVIDER}
NKO_LLM_API_KEY=${LLM_API_KEY}
NKO_LLM_MODEL=${LLM_MODEL}
NKO_LLM_BASE_URL=${LLM_BASE_URL}
NKO_OAUTH_BASE_URL=${OAUTH_BASE_URL}
NKO_GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID}
NKO_GOOGLE_CLIENT_SECRET=${GOOGLE_CLIENT_SECRET}
NKO_FACEBOOK_CLIENT_ID=${FACEBOOK_CLIENT_ID}
NKO_FACEBOOK_CLIENT_SECRET=${FACEBOOK_CLIENT_SECRET}
