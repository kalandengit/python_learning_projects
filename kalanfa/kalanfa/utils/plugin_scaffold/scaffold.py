...
``kalanfa.plugins`` entry point (written into the generated ``pyproject.toml``
...
from kalanfa.utils.plugin_scaffold.entrypoint import find_enclosing_pyproject
from kalanfa.utils.plugin_scaffold.entrypoint import insert_entry_point
from kalanfa.utils.plugin_scaffold.entrypoint import module_import_path
from kalanfa.utils.plugin_scaffold.manifest import FRONTEND_DEPENDENCIES
from kalanfa.utils.plugin_scaffold.manifest import MODE_PACKAGE
from kalanfa.utils.plugin_scaffold.manifest import SURFACES
from kalanfa.utils.plugin_scaffold.names import derive_names
from kalanfa.utils.plugin_scaffold.pnpm_workspace import resolve_dependencies
from kalanfa.utils.plugin_scaffold.render import FileSpec
from kalanfa.utils.plugin_scaffold.render import render_tree
...
def scaffold_plugin(
    ...
    """
    Generate a working, discoverable Kalanfa plugin.
    ...
    # pyproject.toml, mirroring kalanfa-sentry-plugin) and inside the module
    ...
    if mode == MODE_PACKAGE:
        ...
        registration_note = (
            ...
            'line to the [project.entry-points."kalanfa.plugins"] table of the '
