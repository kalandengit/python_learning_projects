...
from kalanfa.utils import sanity_checks
...
class SanityCheckTestCase(TestCase):
    @patch("kalanfa.utils.sanity_checks.logging.error")
    @override_option(
        "Paths",
        "CONTENT_DIR",
    ...
    @patch("kalanfa.utils.sanity_checks.logging.error")
    @patch("kalanfa.utils.sanity_checks.os.access", return_value=False)
    ...
    @patch("kalanfa.utils.sanity_checks.shutil.move")
    @patch(
        "kalanfa.utils.sanity_checks.os.path.exists",
