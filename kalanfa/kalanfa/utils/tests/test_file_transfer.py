...
from kalanfa.utils.file_transfer import ChunkedFile
from kalanfa.utils.file_transfer import FileCopy
from kalanfa.utils.file_transfer import FileDownload
from kalanfa.utils.file_transfer import RemoteFile
from kalanfa.utils.file_transfer import retry_import
from kalanfa.utils.file_transfer import RETRY_STATUS_CODE
from kalanfa.utils.file_transfer import SSLERROR
...
class TestTransferNoFullRangesDownloadByteRangeSupport(
    ...
    def test_remote_file_iterator(self):
        output = b""
        with patch(
            "kalanfa.utils.file_transfer.SameHostSession",
...
class TestTransferDownloadByteRangeSupportNotReported(
    ...
    """
    Some versions of Kalanfa do support byte range requests, but do not report an accept-ranges header.
