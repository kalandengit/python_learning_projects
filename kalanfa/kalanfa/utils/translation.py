"""
This module is used to provide translation support for Kalanfa,
...
class KalanfaTranslation(DjangoTranslation):
    domain = "kalanfa"


def translation(language):
    """
    Returns a translation object in the default 'kalanfa' domain.
    """
    global _translations
    if language not in _translations:
        _translations[language] = KalanfaTranslation(
            language,
            localedirs=[os.path.join(os.path.dirname(kalanfa.__file__), "locale")],
        )
...
def prefer_django(fn):
    ...
    and call the kalanfa translation function if needed.
    """
