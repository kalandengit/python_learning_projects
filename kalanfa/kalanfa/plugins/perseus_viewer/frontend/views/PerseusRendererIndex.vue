...
<script>
  ...
  import { Mapper, defaultFilePathMappers } from 'kalanfa-zip/src/fileUtils';
  ...
  // but Kalanfa doesn't use KA's analytics, video, or URL generation.
...
<style lang="scss">
  ...
  .perseus-root {
    ...
    // Instead, we surgically reset just the elements that Kalanfa's
