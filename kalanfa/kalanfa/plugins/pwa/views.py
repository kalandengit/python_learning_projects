...
class PwaManifestView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # App should be scoped to the deployment path of Kalanfa, no higher
        ...
        # it gets implemented by more web engines[1]. So the use of it in Kalanfa
        ...
        # it’s been dropped from the standard. If so, Kalanfa will be left with
...
class PwaServiceWorkerView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["version"] = kalanfa.__version__
        return context
