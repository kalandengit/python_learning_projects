...
import kalanfa.plugins.device.viewsets.device
...
class ChannelOrderTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        channel.root.save()
        self.url = reverse("kalanfa:kalanfa.plugins.device:devicechannelorder")
...
class DeviceChannelMetadataAPITestCase(APITestCase):
    ...
    def test_channelmetadata_resource_info(self):
        ...
        response = self.client.get(
            reverse(
                "kalanfa:kalanfa.plugins.device:device_channel-detail",
                kwargs={"pk": data["id"]},
            ),
            get_params,
        )
    ...
    def test_channelmetadata_include_fields_filter_has_total_resources(self):
        ...
        response = self.client.get(
            reverse("kalanfa:kalanfa.plugins.device:device_channel-list"),
    ...
    @mock.patch.object(
        kalanfa.plugins.device.viewsets.device,
...
class CalculateImportExportSizeViewTestCase(APITestCase):
    ...
    def test_all_nodes_present_studio(self):
        ...
        response = self.client.post(
            reverse("kalanfa:kalanfa.plugins.device:importexportsizeview"),
