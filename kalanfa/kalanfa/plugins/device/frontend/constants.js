export const PageNames = {
  ...
  USERS_SELECT_FACILITY_FOR_IMPORT: 'USERS_SELECT_FACILITY_FOR_IMPORT',
  USERS_IMPORT_USER_WITH_CREDENTIALS: 'USERS_IMPORT_USER_WITH_CREDENTIALS',
  USERS_IMPORT_USER_AS_ADMIN: 'USERS_IMPORT_USER_AS_ADMIN',
};
...
export const ContentWizardErrors = {
  ...
  KALANFA_STUDIO_UNAVAILABLE: 'KALANFA_STUDIO_UNAVAILABLE',
...
export const ContentSources = {
  LOCAL_DRIVE: 'local',
  KALANFA_STUDIO: 'network',
  PEER_KALANFA_SERVER: 'PEER_KALANFA_SERVER',
};
