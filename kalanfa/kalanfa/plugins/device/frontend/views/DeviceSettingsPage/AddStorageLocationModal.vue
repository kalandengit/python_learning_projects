  ...
  export default {
    ...
    $trs: {
      ...
      newStorageLocationDescription: {
        message:
          'Copy and paste a file path from your Kalanfa server that contains Kalanfa channels. By default, channels exported to a drive from Kalanfa will be in a content folder called KALANFA_DATA_DIR.',
