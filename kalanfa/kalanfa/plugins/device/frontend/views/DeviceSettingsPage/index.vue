  ...
  export default {
    ...
    methods: {
      ...
      getFacilitySettingsPath(facilityId = '') {
        const getUrl = urls['kalanfa:kalanfa.plugins.facility:facility_management'];
        if (getUrl) {
          if (facilityId) {
    ...
    $trs: {
      ...
      signInPageChoice: {
        ...
        context: 'Refers to an option to set the default Kalanfa landing page.',
      },
      ...
      allowExternalConnectionsApp: {
        message: 'Allow others in the network to access Kalanfa on this device using a browser',
        context:
          'Description of a device setting option. This option is visible only When Kalanfa runs on an Android app',
      },
      ...
      externalDeviceSettings: {
        ...
        context: 'Label for device settings controlling how Kalanfa interacts with other devices.',
      },
      ...
      DownloadOnMeteredConnectionDescription: {
        message:
          'If users on this device are using Kalanfa with a limited data plan, they may have to pay extra charges on a mobile connection.',
        context:
          'Warns the user of potential extra charges if using Kalanfa with a limited data plan.',
      },
      doNotAllowDownload: {
      ...
      primaryStorageDescription: {
        message:
          'Kalanfa channels are stored here. Newly downloaded resources will be added to this location.',
        context: 'Informs user of storage location for Kalanfa channels and new resources',
      },
      secondaryStorage: {
      ...
      secondaryStorageDescription: {
        message:
          'Kalanfa will display channels stored in these locations. Read-only locations cannot be the primary storage location.',
      ...
      enableAutoDownloadDescription: {
        message:
          "Kalanfa will automatically download assigned lessons, quizzes, and other resources on the 'My downloads' list.",
      ...
      allowLearnersDownloadDescription: {
        message:
          "Allow users to explore resources they don't have, and mark them for Kalanfa to automatically download when available in their network.",
        context:
      ...
      setStorageLimitDescription: {
        message:
          'Kalanfa will not auto-download more than a set amount of remaining storage on the device',
      ...
      alertDisabledOptions: {
        message: 'Some configuration options are disabled due to the way Kalanfa has been set up.',
        context: 'Alert text that is provided if some options are disabled',
      },
      alertDisabledPaths: {
        message: 'This Kalanfa is not set up to manage its own resource files locally.',
        context: 'Alert text that is provided if some storage locations are disabled',
      },
      alertDisabledPlugins: {
        message:
          'This Kalanfa is not able to initiate a restart from the user interface - management of the enabled pages will have to happen from the command line, and Kalanfa will have to be restarted manually.',
