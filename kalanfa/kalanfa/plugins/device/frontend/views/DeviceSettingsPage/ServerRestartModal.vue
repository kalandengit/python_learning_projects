  ...
  export default {
    ...
    $trs: {
      ...
      newPrimaryLocationRestartDescription: {
        message:
          'Server needs to restart to add a new storage location. Anyone using Kalanfa on this server at this time will temporarily be unable to access it.',
        context: 'Reason to restart the server.',
      },
      ...
      serverRestartDescription: {
        message:
          'Anyone using Kalanfa on this server right now will temporarily be unable to use it.',
      ...
      enableOrDisableRequiresRefresh: {
        message:
          'When you enable or disable a page, Kalanfa will restart, and you must refresh the browser to see the changes. Anyone using Kalanfa on this server at this time will be temporarily disconnected.',
