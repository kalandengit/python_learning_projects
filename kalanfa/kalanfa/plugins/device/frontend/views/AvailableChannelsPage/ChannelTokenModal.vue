  ...
  export default {
    ...
    $trs: {
      channelTokenLabel: {
        ...
        context:
          'Each Kalanfa channel has its own token in Kalanfa Studio. Users can freely view and browse resources to import from the public channels in Kalanfa, but in order to import resources from private or unlisted channels, the user will need the channel token from the resources curator who assembled it.',
      },
      enterChannelToken: {
      ...
      invalidTokenMessage: {
        ...
        context: 'Message that displays if Kalanfa detects an invalid channel token.',
      },
      networkErrorMessage: {
        message: 'Unable to connect to token',
        context:
          'Message that displays if Kalanfa is unable to connect to a channel using a token because of a network error.\n',
      },
      tokenExplanation: {
        message: 'Channel tokens unlock unlisted channels from Kalanfa Studio',
