...
<script>
  ...
  import { TransferTypes, TaskTypes } from 'kalanfa-common/utils/syncTaskUtils';
  ...
  export default {
    ...
    computed: {
      ...
      toolbarTitle() {
        switch (this.transferType) {
          ...
          default:
            return this.$tr('importFromKalanfaStudio');
        }
      },
      channelsAreLoading() {
        return this.status === 'LOADING_CHANNELS_FROM_KALANFA_STUDIO';
      },
    ...
    $trs: {
      ...
      importFromKalanfaStudio: {
        message: 'Import from Kalanfa Studio',
        context: 'Option to import resources from Kalanfa Studio.',
      },
      ...
      documentTitleForRemoteImport: {
        message: 'Available Channels on Kalanfa Studio',
        context: 'Indicates the available resource channels on Kalanfa Studio.',
      },
      noChannelsAvailable: {
