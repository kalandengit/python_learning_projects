...
<script>
  ...
  import { PermissionTypes, UserKinds } from 'kalanfa/constants';
  ...
  export default {
    ...
    $trs: {
      ...
      canManageContentLabel: {
        ...
        context:
          "One of the options in the 'Permissions' filter on the Device permissions page. Type of permission that allows users to import, export and manage channels and resources in Kalanfa.",
      },
