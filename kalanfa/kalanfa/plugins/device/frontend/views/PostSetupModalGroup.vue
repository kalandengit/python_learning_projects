...
<script>
  ...
  import SelectDeviceForm from 'kalanfa-common/components/syncComponentSet/SelectDeviceModalGroup/SelectDeviceForm';
  ...
  export default {
    ...
    $trs: {
      chooseAnotherSourceLabel: {
        ...
        context:
          'Button that opens the modal to choose source for content import workflow from Kalanfa Studio or an attached local drive',
      },
