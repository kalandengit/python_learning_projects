...
<script>
  ...
  const errorToTrStringMap = {
    ...
    [ContentWizardErrors.KALANFA_STUDIO_UNAVAILABLE]: 'kalanfaStudioUnavailable',
  ...
  export default {
    ...
    $trs: {
      ...
      networkLocationUnavailable: {
        message: 'The Kalanfa server on the selected device is not available at the moment',
        context: 'Error message.\n',
      },
      ...
      kalanfaStudioUnavailable: {
        message: 'Kalanfa Studio is unavailable',
        context: 'Error message.',
      },
      networkLocationDoesNotHaveChannel: {
