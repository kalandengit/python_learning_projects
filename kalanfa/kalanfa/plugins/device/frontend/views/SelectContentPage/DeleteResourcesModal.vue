  ...
  export default {
    ...
    $trs: {
      ...
      deleteEverywhereLabel: {
        ...
        context:
          'When some of the resources the admin selected are present in multiple channels, Kalanfa will provide an option for the admin to delete all instances ',
      },
      deleteEverywhereExplanationOneResource: {
        message: 'Some copies of this resource may be in other locations on your device',
        context:
          'When some of the resources admin selected are present in multiple channels, Kalanfa will provide an option for the admin to delete all instances ',
      },
