...
<script>
  ...
  export default {
        ...
        if (this.wholePageError) {
          ...
          if (this.inRemoteImportMode) {
            if (this.$route.query.last === PageNames.MANAGE_CHANNEL) {
              ...
              title = this.$tr('kalanfaStudioLabel');
            }
    ...
    $trs: {
      ...
      kalanfaStudioLabel: {
        message: 'Kalanfa Studio',
        context:
          'Refers to importing channels from Kalanfa Studio. Kalanfa Studio is the tool used to organize learning resources and build channels for Kalanfa. See also https://kalanfa-studio.readthedocs.io/en/latest/index.html',
      },
      importingFromDrive: {
