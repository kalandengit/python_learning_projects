  ...
  export default {
    ...
    $trs: {
      title: {
        ...
        context:
          'Public channels on Kalanfa Studio are periodically updated from their original sources. Private and unlisted channels on a local Kalanfa device may also have changed since they were first imported.\n\nThis section is where the user would update these channels.',
      },
