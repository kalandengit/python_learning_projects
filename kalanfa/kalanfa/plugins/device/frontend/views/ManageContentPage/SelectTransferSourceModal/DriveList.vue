  ...
  export default {
    ...
    $trs: {
      drivesFound: {
        ...
        context:
          'Refers to importing and exporting channels from external USB or disk drives that Kalanfa can recognize and export channels to.',
      },
      noImportableDrives: {
        message: 'No USB or network drives with Kalanfa resources are connected to the server.',
        context:
          "Error message that refers to importing resources. If the drive being used doesn't have Kalanfa resources on it, then this message will display.",
      },
      ...
      noExportableDrives: {
        ...
        context: "Error message that displays if Kalanfa can't find a drive to export data to.",
      },
    },
  };
