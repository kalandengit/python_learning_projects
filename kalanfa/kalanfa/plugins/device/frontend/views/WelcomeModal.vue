...
<script>
  ...
  import { kalanfaOnboardingGuideStrings } from 'kalanfa/uiText/kalanfaOnboardingGuideStrings';
  ...
  export default {
    ...
    setup() {
      ...
      const { onMyOwnWelcomeMessage$, HomePageWelcomeMessage$ } = kalanfaOnboardingGuideStrings;
