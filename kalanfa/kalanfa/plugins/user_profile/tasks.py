...
from kalanfa.core.auth.middleware import clear_user_cache_on_delete
from kalanfa.core.auth.models import FacilityUser
from kalanfa.core.auth.tasks import PeerImportSingleSyncJobValidator
from kalanfa.core.auth.utils.delete import delete_facility
from kalanfa.core.auth.utils.migrate import merge_users
...
from kalanfa.core.tasks.permissions import BasePermission
from kalanfa.core.tasks.permissions import IsFacilityAdmin
from kalanfa.core.tasks.permissions import IsSuperAdmin
from kalanfa.core.tasks.permissions import PermissionsFromAny
...
class MergeUserValidator(PeerImportSingleSyncJobValidator):
    ...
    def create_remote_user(self, data):
        ...
        public_signup_url = reverse_path("kalanfa:core:publicsignup-list")
        try:
