...
<script>
  ...
  import PermissionsIcon from 'kalanfa-common/components/labels/PermissionsIcon';
  ...
  import { PermissionTypes } from 'kalanfa/constants';
  import useUser from 'kalanfa/composables/useUser';
  import GenderDisplayText from 'kalanfa-common/components/userAccounts/GenderDisplayText';
  import BirthYearDisplayText from 'kalanfa-common/components/userAccounts/BirthYearDisplayText';
  import useTotalProgress from 'kalanfa/composables/useTotalProgress';
  ...
  export default {
    ...
    $trs: {
      ...
      learnModalLine1: {
        message:
          'Learning facility represents the location where you are using Kalanfa, such as a school, training center, or a home.',
        context:
