...
import { useFacilityMock } from 'kalanfa-common/composables/__mocks__/useFacility';
...
import { DemographicConstants, UserKinds } from 'kalanfa/constants';
...
jest.mock('kalanfa-common/apiResources/FacilityUserResource');
jest.mock('kalanfa-common/apiResources/RoleResource');
jest.mock('kalanfa-common/apiResources/MembershipResource');
