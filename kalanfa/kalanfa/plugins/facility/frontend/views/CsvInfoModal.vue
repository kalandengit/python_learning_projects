...
<script>
  ...
  export default {
    ...
    $trs: {
      ...
      uuidInfo: {
        message:
          'An ID used by Kalanfa to uniquely identify a user. Leave it blank to create a new user',
        context:
