...
<script>
  ...
  import FacilityNameAndSyncStatus from 'kalanfa-common/components/syncComponentSet/FacilityNameAndSyncStatus';
  import ConfirmationRegisterModal from 'kalanfa-common/components/syncComponentSet/ConfirmationRegisterModal';
  import RegisterFacilityModal from 'kalanfa-common/components/syncComponentSet/RegisterFacilityModal';
  import SyncFacilityModalGroup from 'kalanfa-common/components/syncComponentSet/SyncFacilityModalGroup';
  ...
  import { SyncPageNames } from 'kalanfa-common/components/SyncSchedule/constants';
  ...
  export default {
    ...
    $trs: {
      syncData: {
        ...
        context:
          'Option to sync the current facility data with the Learning Equality Kalanfa Data Portal in the cloud.',
      },
      learnMore: {
      ...
      sync: {
        message: 'Sync',
        context:
          "Describes the 'sync' button which is used to synchronize data from a facility with the project on the Kalanfa Data Portal.",
      },
    },
  };
