...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      downloadCsv() {
        window.open(
          urls['kalanfa:kalanfa.plugins.facility:download_csv_file']('user', this.facilityId),
          '_blank',
        );
      },
    },
    $trs: {
      ...
      downloadCSV: {
        ...
        context: 'Button used to export spreadsheets from Kalanfa.',
      },
      import: {
        message: 'Import',
        context: 'Button used to import spreadsheets from Kalanfa.\n',
      },
      generatingCSV: {
        message: 'Generating CSV...',
        context:
          'Refers to when a CSV is being generated. During the export process this texts displays to indicate that the CSV file is being generated by Kalanfa.',
      },
      viewFormat: {
