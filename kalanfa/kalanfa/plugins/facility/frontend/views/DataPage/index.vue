...
<script>
  ...
  import validationConstants from 'kalanfa-design-system/lib/KDateRange/validationConstants';
  import { currentLanguage } from 'kalanfa/utils/i18n';
  import { now } from 'kalanfa/utils/serverClock';
  import format from 'date-fns/format';
  import KDateRange from 'kalanfa-design-system/lib/KDateRange';
  ...
  export default {
    ...
    methods: {
      ...
      downloadSessionLog() {
        window.open(
          urls['kalanfa:kalanfa.plugins.facility:download_csv_file']('session', this.facilityId),
          '_blank',
        );
      },
      downloadSummaryLog() {
        window.open(
          urls['kalanfa:kalanfa.plugins.facility:download_csv_file']('summary', this.facilityId),
          '_blank',
        );
      },
    },
    $trs: {
      ...
      documentTitle: {
        message: 'Manage Data',
        context: 'Refers to the page title of the Facility > Data section of Kalanfa.',
      },
      download: {
        message: 'Download',
