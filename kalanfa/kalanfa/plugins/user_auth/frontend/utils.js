...
import { SIGNED_OUT_DUE_TO_INACTIVITY } from 'kalanfa/constants';
...
const snackbarTranslator = createTranslator('UserPageSnackbars', {
  ...
  signedOut: {
    ...
    context:
      'Kalanfa will automatically sign out users if they are inactive after a certain period of time. This is the message the user sees when they are signed out.',
  },
});
