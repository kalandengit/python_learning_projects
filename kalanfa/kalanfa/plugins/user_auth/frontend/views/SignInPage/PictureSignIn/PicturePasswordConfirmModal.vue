...
<script>
  ...
  import KFocusTrap from 'kalanfa-design-system/lib/KFocusTrap';
  import KOverlay from 'kalanfa-design-system/lib/KOverlay';
  ...
  import useReturnFocusOnUnmount from 'kalanfa-common/composables/useReturnFocusOnUnmount';
