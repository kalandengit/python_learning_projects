  ...
  <div class="fh">
            ...
            <template v-else>
              ...
              >
                ...
                <KExternalLink
                  ...
                  :text="$tr('poweredByKalanfa')"
                  :primary="true"
                  href="https://learningequality.org/r/powered_by_kalanfa"
                  :openInNewTab="true"
                  appearance="basic-link"
                />
              </p>
      ...
      <div class="table-row">
        ...
        >
          ...
          <div class="small-text">
            ...
            <CoreLogo
              v-if="themeConfig.signIn.showKalanfaFooterLogo"
              class="footer-logo"
            />
            <span v-else> • </span>
            <KButton
    ...
    >
      ...
      <p>
        ...
        <KExternalLink
          text="https://learningequality.org/kalanfa"
          :primary="true"
          href="https://learningequality.org/r/powered_by_kalanfa"
          :openInNewTab="true"
          appearance="basic-link"
...
<script>
  ...
  import CoreLogo from 'kalanfa/components/CoreLogo';
  import PrivacyInfoModal from 'kalanfa/components/PrivacyInfoModal';
  ...
  export default {
    ...
    computed: {
      ...
      guestURL() {
        return urls['kalanfa:core:guest']();
      },
      loginItems() {
    ...
    $trs: {
      accessAsGuest: {
        ...
        context:
          'Link on sign in page which upon clicking allows user to access Kalanfa as a guest user.',
      },
      oidcGenericExplanation: {
        message:
          'Kalanfa is an e-learning platform. You can also use your Kalanfa account to log in to some third-party applications.',
        context: 'Generic explanation about Kalanfa.',
      },
      // eslint-disable-next-line kalanfa/vue-no-unused-translations
      oidcSpecificExplanation: {
        message:
          "You were sent here from the application '{app_name}'. Kalanfa is an e-learning platform, and you can also use your Kalanfa account to access '{app_name}'.",
        context:
          'Explanation of Kalanfa that a user sees if they are sent to Kalanfa from a different application.',
      },
      poweredBy: {
        message: 'Kalanfa {version}',
        context:
          'Indicates the current version of Kalanfa.\n\nFor languages with non-latin scripts, Kalanfa should be transcribed phonetically into the target language, similar to a person\'s name. It should not be translated as "hummingbird".',
      },
      poweredByKalanfa: {
        message: 'Powered by Kalanfa',
        context: 'Indicates that Kalanfa is the technology behind this application.',
      },
      whatsThis: {
        message: "What's this?",
      ...
      restrictedAccess: {
        message: 'Access to Kalanfa has been restricted for external devices',
