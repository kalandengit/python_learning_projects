...
<script>
  ...
  import { languageIdToCode } from 'kalanfa/utils/i18n';
  ...
  import useKResponsiveElement from 'kalanfa-design-system/lib/composables/useKResponsiveElement';
  ...
  export default {
    ...
    $trs: {
      ...
      captions: {
        message: 'Captions',
        context:
          "The Kalanfa media player allows learners to view audiovisual content with subtitles (captions) in different languages. These are accessed via the 'CC' option on the player.",
      },
      captionsOff: {
