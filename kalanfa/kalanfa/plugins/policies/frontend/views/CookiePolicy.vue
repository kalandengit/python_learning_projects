    ...
    <KPageContainer>
      ...
      <section>
        ...
        <table>
          ...
          <tr>
            <td>kalanfa_csrftoken</td>
            <td>{{ $tr('csrftokenCookiePurpose') }}</td>
            <td>{{ $tr('twoYearExpiry') }}</td>
          </tr>
          <tr>
            <td>kalanfa</td>
            <td>{{ $tr('kalanfaCookiePurpose') }}</td>
            <td>{{ $tr('kalanfaCookieExpiry') }}</td>
          </tr>
          <tr>
            <td>kalanfa_cookie_consent</td>
            <td>{{ $tr('kalanfaCookieConsentPurpose') }}</td>
            <td>{{ $tr('twoYearExpiry') }}</td>
          </tr>
...
<script>
  ...
  export default {
    ...
    $trs: {
      cookieP1: {
        message:
          "The Kalanfa Learning Platform uses cookies to personalize and secure your experience, to analyze traffic, and to improve the performance and functionality of its service. Cookies are small text files that can be used by websites to make a user's experience more efficient.",
      },
      cookieP2: {
        message:
      ...
      cookieP3: {
        message:
          'The Kalanfa Learning Platform uses different types of cookies. Some cookies are strictly necessary, and some are for optional analytics purposes. You can at any time change or withdraw your consent.',
      },
      cookieP4: {
