<template>
  ...
  >
    ...
    <component
      ...
      class="vue-recycle-scroller-item-wrapper"
      :class="listClass"
    >
      <component
        :is="itemTag"
      ...
      sizes() {
        if (this.itemSize === null) {
          ...
          for (let i = 0, l = items.length; i < l; i++) {
            // sizeField can be a number or a function returning a number
            current =
              (typeof items[i][field] === 'function' ? items[i][field]() : items[i][field]) ||
              minItemSize;
        ...
        if (!count) {
          ...
          if (itemSize === null) {
            ...
            for (
              ...
              beforeSize + sizes[visibleStartIndex].accumulator < scroll.start;
              visibleStartIndex++
            );
            ...
            for (
              ...
              beforeSize + sizes[visibleEndIndex].accumulator < scroll.end;
              visibleEndIndex++
            );
          } else {
            // Fixed size mode
