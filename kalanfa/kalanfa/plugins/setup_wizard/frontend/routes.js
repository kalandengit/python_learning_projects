...
import HowAreYouUsingKalanfa from './views/onboarding-forms/HowAreYouUsingKalanfa';
...
import SettingUpKalanfa from './views/onboarding-forms/SettingUpKalanfa';
...
export default [
  {
    path: '/',
    name: 'HOW_ARE_YOU_USING_KALANFA',
    component: HowAreYouUsingKalanfa,
  },
  {
