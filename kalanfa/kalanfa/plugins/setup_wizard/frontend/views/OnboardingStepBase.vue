  ...
  >
    <div class="logo-lang-container">
      ...
      >
        ...
        <span class="logo-text">{{ coreString('kalanfaLabel') }}</span>
      </div>
...
<script>
  ...
  import { error as coreError, clearError } from 'kalanfa/utils/appError';
  import { availableLanguages, currentLanguage } from 'kalanfa/utils/i18n';
...
<style lang="scss" scoped>
  ...
  @import 'kalanfa-common/styles/definitions';
