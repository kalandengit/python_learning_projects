...
<script>
  ...
  import SelectDeviceModalGroup from 'kalanfa-common/components/syncComponentSet/SelectDeviceModalGroup';
  import RadioButtonGroup from 'kalanfa-common/components/syncComponentSet/RadioButtonGroup';
