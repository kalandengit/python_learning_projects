  ...
  export default {
    ...
    $trs: {
      whatKindOfDeviceTitle: {
        ...
        context:
          'Title for the Kalanfa setup wizard step where user decides if they want to configure their device as only used by one or more learners, of as a full device to also be used by coaches and administrators.',
      },
      fullDeviceLabel: {
        message: 'Full device',
        context: '',
      ...
      fullDeviceDescription: {
        message:
          'This device will be a fully-featured Kalanfa server used by admins, coaches, and learners.',
        context: '',
      },
