<template>
  ...
  <OnboardingStepBase
    dir="auto"
    :noBackAction="true"
    :title="getCommonSyncString('howAreYouUsingKalanfa')"
  ...
  export default {
    ...
    $trs: {
      ...
      groupLearningDescription: {
        message:
          'This device will need to connect with other devices using Kalanfa in schools or other group learning settings.',
        context: 'desc',
      },
    },
  };
