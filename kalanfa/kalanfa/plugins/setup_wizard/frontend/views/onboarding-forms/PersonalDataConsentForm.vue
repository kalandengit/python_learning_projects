...
<script>
  ...
  export default {
    ...
    $trs: {
      description: {
        message:
          'If you are setting up Kalanfa for other users, you or someone you delegate will need to be responsible for protecting and managing their accounts and personal information.',
        context: "Description of the 'Responsibilities as an administrator' page.",
      },
      header: {
        message: 'Responsibilities as an administrator',
        context:
          'When an admin sets up a Kalanfa facility they need to take into consideration the relevant privacy laws and regulations. This is the title of that section in the set up process where they can view those regulations.',
      },
    },
  };
