  ...
  export default {
    ...
    $trs: {
      gettingStartedHeader: {
        message: 'How do you plan to use Kalanfa?',
        context: 'Page title',
      },
      descriptionParagraph1: {
        message:
          'In Kalanfa, you can use a facility to manage a large group of users, like a school, an educational program or any other group learning setting. You can also have multiple facilities on the same device.',
