<template>
  ...
  <OnboardingForm
    :header="getCommonSyncString('howAreYouUsingKalanfa')"
    @submit="handleSubmit"
  >
    <KRadioButtonGroup>
      <KRadioButton
  ...
  export default {
    ...
    $trs: {
      ...
      advancedSetupDescription: {
        message:
          'For schools, educational programs, organizations, or other group learning settings that will share the use of Kalanfa',
