...
<script>
  ...
  export default {
    ...
    $trs: {
      ...
      description: {
        message:
          'This option allows anyone to view educational materials on Kalanfa without needing to make an account',
        context:
          "Description of the 'Enable guest access?' option that an admin can configure in the set up process. It means that anyone can access Kalanfa without having to create an account.",
      },
      header: {
        message: 'Enable users to explore Kalanfa without an account?',
        context:
          'Option that an admin can configure in the set up process. If selected, guests can access Kalanfa without the need to create an account.',
      },
      noOptionLabel: {
        message: 'No. Users must have an account to explore Kalanfa.',
