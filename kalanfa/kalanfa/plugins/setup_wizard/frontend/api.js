 ...
 * name in the kalanfa.plugins.setup_wizard.api module (note how the definitions of)
 * the Resource instances below have 'kalanfa.plugins.setup_wizard' for their 'namespace'.
 */

export const SetupWizardResource = new Resource({
  name: 'setupwizard',
  namespace: 'kalanfa.plugins.setup_wizard',
