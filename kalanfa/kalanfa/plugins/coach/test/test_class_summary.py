...
from kalanfa.core.lessons import models
...
from kalanfa.core.logger.test.helpers import EvaluationMixin
...
from kalanfa.plugins.coach.viewsets.class_summary import content_status_serializer
...
class ClassSummaryTestCase(EvaluationMixin, APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.basename = "kalanfa:kalanfa.plugins.coach:classsummary"
...
class ClassSummaryDiffTestCase(EvaluationMixin, APITestCase):
    ...
    def test_practice_quiz_summary(self):
        ...
        response = self.client.get(
            reverse(
                "kalanfa:kalanfa.plugins.coach:classsummary-detail",
