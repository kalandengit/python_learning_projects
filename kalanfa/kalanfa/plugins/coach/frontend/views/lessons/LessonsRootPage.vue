...
<script>
  ...
  import LessonResource from 'kalanfa-common/apiResources/LessonResource';
  import { LESSON_VISIBILITY_MODAL_DISMISSED, ERROR_CONSTANTS } from 'kalanfa/constants';
  ...
  import useKShow from 'kalanfa-design-system/lib/composables/useKShow';
