...
<script>
  ...
  import InfoIcon from 'kalanfa-common/components/labels/CoreInfoIcon';
  import SlotTruncator from 'kalanfa-common/components/SlotTruncator';
  import MasteryModel from 'kalanfa-common/components/labels/MasteryModel';
  import commonCoreStrings from 'kalanfa/uiText/commonCoreStrings';
  import { licenseLongName, licenseDescriptionForConsumer } from 'kalanfa/uiText/licenses';
