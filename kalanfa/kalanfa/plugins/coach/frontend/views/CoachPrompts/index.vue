<template>
  ...
  <div :style="{ padding: '32px', backgroundColor: $themeTokens.surface }">
    ...
    <h3>Choosing Kalanfa resources</h3>
    ...
    <h3>Use "Questioning" along with a Kalanfa resource</h3>

    <p>Increase learner engagement with content and promote active learning with questions.</p>

    <p>Identify resources</p>
    <ul>
      <li>What Kalanfa resource will you use for your lesson objective?</li>
    ...
    <ul>
      <li>Viewed a Kalanfa resource on a projector</li>
      <li>Practiced Kalanfa exercises independently</li>
    ...
    <p>Peer Tutoring</p>
    <p>
      Coach pairs learners to help one another understand concepts on Kalanfa. This promotes learner
    ...
    <p>
      ...
      Kalanfa, stepping in for assistance as needed. The coach can -
    </p>
    <ul>
    ...
    <p>
      ...
      or resource room. Learners access Kalanfa to review content, check understanding, and follow
      their own interests
    </p>
    <hr >
    <p>Reflect</p>
    ...
    <h3>Kalanfa Session Checklist</h3>
    ...
    <p>Hardware/Software Checklist for Kalanfa use:</p>
    <ul>
    ...
    <p>
      The "Group" feature in Kalanfa will allow you to meet learning needs of different learners
    </p>
    <p>Creating "groups"</p>
    <ul>
    ...
    <p>
      Use the Lessons features and search in Kalanfa for appropriate resources based on the learning
    ...
    <p>Involve learners in setting up their own ground rules for group work using Kalanfa</p>
    ...
    <ul>
      <li>Assign learners additional resources using the Lessons feature in Kalanfa</li>
    ...
    <ul>
      <li>
        Assign additional resources using the "lessons" feature in Kalanfa based on their specific
        learning needs
      </li>
