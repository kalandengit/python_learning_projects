  ...
  export default {
    ...
    $trs: {
      ...
      noAssignedClassesDetails: {
        message: 'Please consult your Kalanfa administrator to be assigned to a class',
        context:
          'Coach accounts in Kalanfa are created by admins. If the coach has no classes assigned to them by the admin, this message displays in the Coach > Classes section. ',
      },
      ...
      noClassesDetailsForFacilityCoach: {
        message: 'Please consult your Kalanfa administrator',
        context:
