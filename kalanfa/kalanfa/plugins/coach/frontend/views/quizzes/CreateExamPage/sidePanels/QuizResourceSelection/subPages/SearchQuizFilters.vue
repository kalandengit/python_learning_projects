...
<script>
  ...
  import SearchFiltersPanel from 'kalanfa-common/components/SearchFiltersPanel/index.vue';
  import { searchAndFilterStrings } from 'kalanfa-common/strings/searchAndFilterStrings';
  import { useGoBack } from 'kalanfa-common/composables/usePreviousRoute.js';
