...
<script>
  ...
  import useAccordion from 'kalanfa-common/components/useAccordion';
  import AccordionItem from 'kalanfa-common/components/AccordionItem';
  import AccordionContainer from 'kalanfa-common/components/AccordionContainer';
