...
<script>
  ...
  import { ContentNodeKinds, MAX_QUESTIONS_PER_QUIZ_SECTION } from 'kalanfa/constants';
  ...
  import usePreviousRoute from 'kalanfa-common/composables/usePreviousRoute.js';
