...
<script>
  ...
  import Draggable from 'kalanfa-common/components/sortable/Draggable';
  import DragHandle from 'kalanfa-common/components/sortable/DragHandle';
  import DragContainer from 'kalanfa-common/components/sortable/DragContainer';
  import DragSortWidget from 'kalanfa-common/components/sortable/DragSortWidget';
  import AccordionItem from 'kalanfa-common/components/accordion/AccordionItem';
  import commonCoreStrings from 'kalanfa/uiText/commonCoreStrings';
  import AccordionContainer from 'kalanfa-common/components/accordion/AccordionContainer';
