...
<script>
  ...
  import AccessibleFolderCard from 'kalanfa-common/components/Cards/AccessibleFolderCard';
  import AccessibleResourceCard from 'kalanfa-common/components/Cards/AccessibleResourceCard';
  ...
  export default {
    ...
    setup() {
      ...
      function deleteBookmark(contentnode_id) {
        client({
          method: 'delete',
          url: urls['kalanfa:core:bookmarks_detail'](contentnode_id),
        }).then(() => {
          getBookmarks();
