...
const coachStrings = createTranslator('CommonCoachStrings', {
  ...
  lessonDuplicateTitleError: {
    ...
    context:
      'Error message. Displays when a user tries to use a name for a lesson that already exists in Kalanfa.',
  },
...
const MissingContentStrings = createTranslator('MissingContentStrings', {
  upgradeKalanfaTitle: {
    message: 'Upgrade Kalanfa to view resources',
    context: 'Title of the modal window',
  },
  upgradeKalanfaP1: {
    message:
      'Some resources are not supported by this version of Kalanfa. You may need to upgrade to view them.',

    context: 'First paragraph of the "Upgrade Kalanfa to view resources" modal',
  },
  upgradeKalanfaLinkText: {
    message: 'Go to download page',
    context:
      'Text for the link displayed at the bottom of the "Upgrade Kalanfa to view resources" modal',
  },
});
