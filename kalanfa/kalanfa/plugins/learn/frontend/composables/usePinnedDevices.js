...
import PinnedDeviceResource from 'kalanfa-common/apiResources/PinnedDeviceResource';
...
export default function usePinnedDevices(networkDevicesWithChannels) {
  ...
  function _isPinnedDevice(device) {
    return get(userPinsMap)[device.instance_id] || device.instance_id === KalanfaStudioId;
  }
