...
export const PageNames = {
  ...
  COURSE_CONTENT__COURSE: 'COURSE_CONTENT__COURSE',
  COURSE_CONTENT__UNIT: 'COURSE_CONTENT__UNIT',
  COURSE_CONTENT__LESSON: 'COURSE_CONTENT__LESSON',
  COURSE_CONTENT__RESOURCE: 'COURSE_CONTENT__RESOURCE',
...
export const KalanfaStudioId = plugin_data.studioDevice?.instance_id;
