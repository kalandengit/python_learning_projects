...
import KCircularLoader from 'kalanfa-design-system/lib/loaders/KCircularLoader';
...
import useBaseSearch, { useBaseSearchMock } from 'kalanfa-common/composables/useBaseSearch';
...
jest.mock('kalanfa-common/composables/useBaseSearch');
jest.mock('kalanfa/composables/useUser');
jest.mock('kalanfa-common/utils/samePageCheckGenerator', () => jest.fn(() => () => true));
