            ...
            <template v-else>
              ...
              >
                <KGrid :style="{ marginTop: '6px' }">
                  ...
                  >
                    <ResourceItem
                      data-testid="recommended-resource"
                      :contentNode="node"
...
<script>
  ...
  import { MaxPointsPerContent } from 'kalanfa/constants';
  ...
  export default {
    ...
    $trs: {
      signIn: {
        ...
        context:
          'Message that a learner will see upon completing a resource if they are not signed in to Kalanfa.',
      },
      plusPoints: {
