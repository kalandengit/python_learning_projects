...
<script>
  ...
  import checkMeteredConnection from 'kalanfa-common/utils/checkMeteredConnection';
  import LearningActivityChip from 'kalanfa-common/components/ResourceDisplayAndSearch/LearningActivityChip.vue';
  import { searchKeys } from 'kalanfa-common/composables/useBaseSearch';
  import SidePanelModal from 'kalanfa-common/components/SidePanelModal';
  import SearchFiltersPanel from 'kalanfa-common/components/SearchFiltersPanel';
  ...
  import { KalanfaStudioId, PageNames } from '../../constants';
      ...
      channelsLabel() {
        if (this.deviceId) {
          if (this.deviceId === this.studioId) {
            return this.learnString('kalanfaLibrary');
          } else {
