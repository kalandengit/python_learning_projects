...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      settingsUrl() {
        return urls['kalanfa:core:devicesettings']();
      },
    ...
    $trs: {
      ...
      modalDescription: {
        message:
          'You may have a limited amount of data on your mobile plan. Allowing Kalanfa to download resources via mobile data may use up your entire plan and/or incur extra charges.',
        context: 'Information in a modal informing a user about their connection status.',
      },
      doNotUseMetered: {
        message: 'Do not allow Kalanfa to use mobile data',
        context: 'An option that a user can select in a form',
      },
      useMetered: {
        message: 'Allow Kalanfa to use mobile data',
        context: 'An option that a user can select in a form',
      },
