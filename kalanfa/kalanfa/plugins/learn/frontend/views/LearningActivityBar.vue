...
<script>
  ...
  import CoachContentLabel from 'kalanfa-common/components/labels/CoachContentLabel';
  import CoreMenu from 'kalanfa/components/CoreMenu';
  import { ContentNodeKinds } from 'kalanfa/constants';
  import CoreMenuOption from 'kalanfa/components/CoreMenu/CoreMenuOption';
  import ProgressIcon from 'kalanfa-common/components/labels/ProgressIcon';
  import KToolbar from 'kalanfa-design-system/lib/KToolbar';
  import { validateLearningActivity } from 'kalanfa/utils/validators';
  ...
  import SuggestedTime from 'kalanfa-common/components/SuggestedTime';
