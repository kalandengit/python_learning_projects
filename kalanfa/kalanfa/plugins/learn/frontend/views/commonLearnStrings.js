...
export const learnStrings = createTranslator('CommonLearnStrings', {
  ...
  learnLabel: {
    message: 'Learn',
    context:
      "Each time a learner signs in to Kalanfa, the first thing they see is the  'Learn' page with the list of all the classes they are enrolled to.",
  },
  resumeLabel: {
    message: 'Resume',
  ...
  kalanfaLibrary: {
    message: 'Kalanfa Library',
    context: 'Title for Kalanfa Libraries',
  },
  ...
  locationsInChannel: {
    ...
    context:
      "When there are multiple instances of the same resource, learner can see their 'locations' (positions in the respective folders of the channel) at the bottom of the sidebar with all the metadata, when they select the resource in the Kalanfa Library.",
  },
  viewResource: {
  ...
  loadingLibraries: {
    message: 'Loading Kalanfa libraries around you',
    context:
      "Status message displayed on the Library page while Kalanfa on the user's device is searching the local network for other devices with Kalanfa, in order to make their libraries available for browsing.",
  },
  cannotConnectToLibrary: {
    message:
      'Kalanfa cannot connect to the library on {deviceName}. Your network connection may be unstable, or {deviceName} is no longer available.',
    context: '',
  },
  backToAllLibraries: {
