...
<script>
  ...
  import ContentNodeSearchResource from 'kalanfa-common/apiResources/ContentNodeSearchResource';
  import router from 'kalanfa/router';
  import { ContentNodeKinds } from 'kalanfa/constants';
  import { events, nameSpace, MessageStatuses } from 'kalanfa-sandbox/src/base';
  ...
  export default {
    ...
    mounted() {
      ...
      this.sandbox.on(events.KALANFAVERSIONREQUESTED, message => {
        this.sendKalanfaVersion.call(this, message);
      });
    ...
    methods: {
      // helper functions for fetching data from kalanfa
