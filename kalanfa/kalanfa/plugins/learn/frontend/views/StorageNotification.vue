...
<script>
  ...
  import { LearnerDeviceStatus } from 'kalanfa/constants';
  ...
  export default {
    ...
    methods: {
      ...
      openDownloads() {
        const downloadsUrl = urls['kalanfa:kalanfa.plugins.learn:my_downloads']();
        redirectBrowser(downloadsUrl);
      },
      manageChannel() {
        const deviceManagementUrl = urls['kalanfa:kalanfa.plugins.device:device_management'];
