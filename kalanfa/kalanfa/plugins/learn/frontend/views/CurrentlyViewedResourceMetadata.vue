...
<script>
  ...
  import { ContentNodeKinds, ContentLevels } from 'kalanfa/constants';
    ...
    methods: {
      toggleShowMoreOrLess() {
        if (this.showMoreOrLess === 'Show More') {
          ...
          /* eslint-enable kalanfa/vue-no-undefined-string-uses */
        }
      },
      ...
      shareFile() {
        const urlFunction = urls['kalanfa:core:sharefile'];
        return client({
          url: urlFunction(),
          method: 'POST',
          data: {
