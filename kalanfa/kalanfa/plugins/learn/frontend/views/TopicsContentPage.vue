...
<script>
  ...
  import { error, handleApiError, clearError } from 'kalanfa/utils/appError';
  import commonCoreStrings from 'kalanfa/uiText/commonCoreStrings';
  import AddDeviceForm from 'kalanfa-common/components/syncComponentSet/SelectDeviceModalGroup/AddDeviceForm';
  import { ContentNodeKinds, ContentErrorConstants } from 'kalanfa/constants';
  ...
  import SkipNavigationLink from 'kalanfa/components/SkipNavigationLink';
    ...
    methods: {
      ...
      toggleBookmark() {
        ...
        if (this.bookmark) {
          client({
            method: 'delete',
            url: urls['kalanfa:core:bookmarks_detail'](this.bookmark.id),
          }).then(() => {
            this.bookmark = false;
          });
