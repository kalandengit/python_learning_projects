...
from kalanfa.core.utils.validators import NoRepeatedValueJSONArrayValidator
...
translations_schema = {
    ...
    "items": {
        "type": "object",
        "properties": {
            # KALANFA_SUPPORTED_LANGUAGES is a set of strings, so we use sorted
            ...
            "language": {"type": "string", "enum": sorted(KALANFA_SUPPORTED_LANGUAGES)},
            "message": {"type": "string"},
        },
    },
    "optional": True,
