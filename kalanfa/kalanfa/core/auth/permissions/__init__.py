...
class KalanfaAuthPermissionsFilter(filters.BaseFilterBackend):
    """
    ...
    to the ``filter_readable`` method on ``KalanfaAbstractBaseUser``.
    """
...
class KalanfaAuthPermissions(permissions.BasePermission):
    """
    A Django REST Framework permissions class that defers to Kalanfa's permissions
