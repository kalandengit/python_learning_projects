...
from kalanfa.core.auth.management import utils
...
from kalanfa.core.auth.sync_event_hook_utils import _local_event_handler
...
from kalanfa.core.auth.test.test_api import LearnerGroupFactory
from kalanfa.core.auth.utils.delete import get_delete_group_for_facility
from kalanfa.core.auth.utils.migrate import fork_facility
from kalanfa.core.auth.utils.migrate import merge_users
from kalanfa.core.logger import models as log_models
...
class GetFacilityTestCase(TestCase):
    ...
    @mock.patch("kalanfa.core.auth.management.utils.input", return_value="3")
...
class GetRemoteUserInfoErrorPathsTestCase(TestCase):
    ...
    def test_connection_failure_raises_resource_gone(self):
        from kalanfa.core.discovery.utils.network.errors import (
