...
from ..models import KalanfaAnonymousUser
...
class ImproperUsageIsProperlyHandledTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.anon_user = KalanfaAnonymousUser()
...
class FacilityPermissionsTestCase(TestCase):
    ...
    def test_anon_users_can_read_facility(self):
        """KalanfaAnonymousUser can now read Facility objects"""
...
class LearnerGroupPermissionsTestCase(TestCase):
    ...
    def test_facility_admins_or_coaches_or_classroom_coach_can_create_learnergroup(
        ...
        self.assertTrue(
            self.data["facility_coach"].can_create(LearnerGroup, new_learnergroup_data)
        )
        self.assertTrue(
...
class FacilityUserPermissionsTestCase(TestCase):
    ...
    def test_facility_user_can_update_self(self):
        ...
        self.assertTrue(
            self.data["facility_coach"].can_update(self.data["facility_coach"])
        )
        self.assertTrue(
    ...
    def test_facility_user_cannot_delete_self(self):
        ...
        self.assertFalse(
            self.data["facility_coach"].can_delete(self.data["facility_coach"])
        )
        self.assertFalse(
...
class RolePermissionsTestCase(TestCase):
    ...
    def test_facility_admin_can_create_classroom_coach_role(self):
        new_role_data = {
            "user": self.role_user,
    ...
    def test_facility_admin_can_delete_classroom_coach_role(self):
        role = Role.objects.create(
            user=self.role_user, collection=self.own_classroom, kind=role_kinds.COACH
        )
        self.assertTrue(self.data["facility_admin"].can_delete(role))
...
class MembershipPermissionsTestCase(TestCase):
    ...
    def test_facility_admin_or_coach_or_member_can_read_membership(self):
