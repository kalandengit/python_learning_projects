...
When creating models for servers passed into test methods from the `multiple_kalanfa_servers`
...
from kalanfa.core.auth.management.utils import get_client_and_server_certs
from kalanfa.core.auth.utils.sync import find_soud_sync_session_for_resume
...
from .sync_utils import multiple_kalanfa_servers
...
class EcosystemTestCase(MultipleServerTestCase):
    ...
    @multiple_kalanfa_servers(
        3,
        env=[
            None,
            {
                "MORANGO_INSTANCE_INFO": "kalanfa.core.auth.test.sync_utils:CUSTOM_INSTANCE_INFO"
            },
            None,
        ],
    )
    def test_scenarios(self, servers):
        ...
        # assert that all kalanfa instances start off equal
        ...
        # missing foreign key lookup should be handled gracefully (https://github.com/learningequality/kalanfa/pull/5734)
        ...
        # requires spoofing kalanfa version in syncing info
...
class EcosystemSingleUserAssignmentTestCase(MultipleServerTestCase):
    ...
    def test_single_user_assignment_sync(self, servers):
        ...
        https://github.com/learningequality/kalanfa/issues/8079
        """
        ...
        # START BUG 11845
        # https://github.com/learningequality/kalanfa/pull/11845
...
class SingleUserSyncRegressionsTestCase(MultipleServerTestCase):
    ...
    @multiple_kalanfa_servers(3)
    def test_kalanfa_issue_8439(self, servers):
        """
        This is to test the syncing issue identified in:
        https://github.com/learningequality/kalanfa/issues/8439
