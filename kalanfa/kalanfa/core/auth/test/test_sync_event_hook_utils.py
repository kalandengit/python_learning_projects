...
MODULE_NAME = "kalanfa.core.auth.sync_event_hook_utils"


@mock.patch("kalanfa.core.auth.sync_event_hook_utils.FacilityDataSyncHook")
class FacilityDataSyncHooksTestCase(SimpleTestCase):
    ...
    @mock.patch("kalanfa.core.auth.sync_event_hook_utils.logger")
