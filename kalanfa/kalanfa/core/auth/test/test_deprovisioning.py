...
from kalanfa.core.content import models as content_models
...
from kalanfa.core.logger.test.factory_logger import UserSessionLogFactory
...
class DeprovisionCommandTestCase(TestCase):
    ...
    @patch("kalanfa.core.auth.management.commands.deprovision.confirm_or_exit")
