...
class AuthMiddlewareTestCase(TestCase):
    ...
    @override_settings(AUTH_ANONYMOUS_USER_MODEL="kalanfaauth")
    ...
    @override_settings(
        AUTH_ANONYMOUS_USER_MODEL="not_a_real_app_name.KalanfaAnonymousUser"
    )
    ...
    @override_settings(
        AUTH_ANONYMOUS_USER_MODEL="kalanfaauth.NotTheKalanfaAnonymousUser"
    )
