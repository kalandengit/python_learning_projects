...
from kalanfa.core.auth.sync_operations import _INTEGRITY_ERROR_EXCEPTION
from kalanfa.core.auth.sync_operations import PicturePasswordCollisionOperation
...
def _make_broken_store(
    ...
    defaults = dict(
        ...
        deserialization_error="UNIQUE constraint failed: kalanfaauth_facilityuser.dataset_id, kalanfaauth_facilityuser.picture_password",
...
class PicturePasswordCollisionOperationTestCase(TestCase):
    ...
    @mock.patch(
        "kalanfa.core.auth.sync_operations.ReceiverDeserializeOperation.handle",
    ...
    @mock.patch(
        "kalanfa.core.auth.sync_operations.get_dataset_id",
    )
    ...
    @mock.patch(
        "kalanfa.core.auth.sync_operations._deserialize_from_store",
    )
    @mock.patch(
        "kalanfa.core.auth.sync_operations.ReceiverDeserializeOperation.handle",
        return_value=transfer_statuses.COMPLETED,
    ...
    @mock.patch(
        "kalanfa.core.auth.sync_operations.are_picture_passwords_exhausted",
        return_value=True,
    )
    ...
    @mock.patch(
        "kalanfa.core.auth.sync_operations.get_all_valid_sequences",
        return_value=set(),
    )
