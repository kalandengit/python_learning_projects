...
from kalanfa.core.auth.constants.picture_passwords import SEQUENCE_LENGTH
from kalanfa.core.auth.constants.role_kinds import ADMIN
from kalanfa.core.auth.errors import NoAvailableSequences
from kalanfa.core.auth.errors import SequenceAlreadyAssigned
...
class AssignPicturePasswordTestCase(TestCase):
    ...
    def test_raises_no_available_sequences_when_pool_exhausted(self):
        ...
        with mock.patch(
            "kalanfa.core.auth.utils.picture_passwords.PICTURE_PASSWORD_SET",
            small_set,
        ):
    ...
    def test_raises_sequence_already_assigned_after_two_integrity_errors(self):
        ...
        with mock.patch(
            "kalanfa.core.auth.utils.picture_passwords.get_available_sequence",
