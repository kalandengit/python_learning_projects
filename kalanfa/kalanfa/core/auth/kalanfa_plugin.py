...
class SingleFacilityUserChangeClearingOperation(KalanfaSingleUserSyncOperation):
...
class CleanUpTaskOperation(KalanfaSyncOperationMixin, LocalOperation):
...
class AuthSyncHook(FacilityDataSyncHook):
    initializing_operations = [
        KalanfaLocalInitializeOperation(),
        KalanfaNetworkInitializeOperation(),
    ]
