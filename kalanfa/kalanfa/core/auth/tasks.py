...
from kalanfa.core.auth.constants.user_kinds import ASSIGNABLE_COACH
from kalanfa.core.auth.constants.user_kinds import COACH
...
from kalanfa.core.auth.utils.picture_passwords import assign_picture_password
from kalanfa.core.auth.utils.picture_passwords import get_learner_count
from kalanfa.core.auth.utils.sync import find_soud_sync_sessions
from kalanfa.core.auth.utils.sync import validate_and_create_sync_credentials
from kalanfa.core.auth.utils.users import get_remote_user_info
from kalanfa.core.auth.utils.users import get_remote_users_info
from kalanfa.core.device import soud
from kalanfa.core.device.translation import get_device_language
...
from kalanfa.core.error_constants import DEVICE_LIMITATIONS
...
from kalanfa.core.tasks.job import JobStatus
...
def status_fn(job):
    # Translators: A notification title shown to users when their Kalanfa device is syncing data to another Kalanfa instance
    data_syncing_in_progress = _("Data syncing in progress")

    # Translators: Notification text shown to users when their Kalanfa device is syncing data to another Kalanfa instance
...
def importusersfromcsv(
    ...
    :param: csvfile: filename of the file stored in kalanfa temp folder
...
def dataportalsync(command, **kwargs):
    """
    Initiate a PUSH sync with Kalanfa Data Portal.
    """
...
def queue_soud_server_sync_cleanup(client_instance_id):
    ...
    :param client_instance_id: The Kalanfa instance ID of the client
    """
