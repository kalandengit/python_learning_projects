...
from kalanfa.core.api import KalanfaDataPortalViewSet
from kalanfa.core.routers import BulkDeleteRouter
...
router.register(r"portal", KalanfaDataPortalViewSet, basename="portal")
