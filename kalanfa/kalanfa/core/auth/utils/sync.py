...
from kalanfa.core.auth.constants.collection_kinds import CLASSROOM
from kalanfa.core.auth.constants.collection_kinds import LEARNERGROUP
from kalanfa.core.auth.constants.morango_sync import PARTITION_CLASSROOM
from kalanfa.core.auth.constants.morango_sync import PARTITION_SUFFIX_COACH_RW
from kalanfa.core.auth.constants.morango_sync import PARTITION_SUFFIX_LEARNER_RW
...
from kalanfa.core.auth.management.utils import get_facility_dataset_id
from kalanfa.core.auth.models import Collection
from kalanfa.core.auth.models import Membership
from kalanfa.core.auth.models import Role
...
class ClassroomPartitionFactory:
    ...
    def get_classroom_collection(cls, collection_id=None, collection=None):
        ...
        :rtype: kalanfa.core.auth.models.Collection
        """
