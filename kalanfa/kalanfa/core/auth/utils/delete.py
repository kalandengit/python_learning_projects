...
from kalanfa.core.analytics.models import PingbackNotificationDismissed
...
from kalanfa.core.exams.models import IndividualSyncableExam
from kalanfa.core.lessons.models import IndividualSyncableLesson
