...
from kalanfa.core.auth.management.utils import get_facility
from kalanfa.core.auth.management.utils import get_network_connection
from kalanfa.core.auth.management.utils import is_portal_sync
...
class Command(MorangoSyncCommand):
    help = "Allow the syncing of facility data with Kalanfa Data Portal or another Kalanfa device."
