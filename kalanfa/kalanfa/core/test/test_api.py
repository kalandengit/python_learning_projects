...
from kalanfa.core.test.test_app.models import Author
from kalanfa.core.test.test_app.models import Book
from kalanfa.core.test.test_app.models import Classroom
from kalanfa.core.test.test_app.models import DateTimeTzModel
from kalanfa.core.test.test_app.models import Enrollment
from kalanfa.core.test.test_app.models import Profile
from kalanfa.core.test.test_app.models import Publisher
from kalanfa.core.test.test_app.models import Tag
