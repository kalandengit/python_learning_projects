...
from kalanfa.core.device.models import SQLiteLock
...
class DBBasedProcessLockTestCase(SimpleTestCase):
    ...
    @unittest.skipIf(
        ...
        the tests in kalanfa/core it fails, and any atomic transaction created in that context also fails to create an atomic block.
        """,
    )
...
class RedisSettingsHelperTestCase(TestCase):
    ...
    @mock.patch("kalanfa.core.utils.cache.logger")
