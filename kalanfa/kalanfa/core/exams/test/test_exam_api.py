...
class BaseExamTest:
    ...
    def post_new_exam(self, exam):
        return self.client.post(reverse("kalanfa:core:exam-list"), exam, format="json")

    def patch_updated_exam(self, exam_id, update):
        return self.client.patch(
            reverse("kalanfa:core:exam-detail", kwargs={"pk": exam_id}),
            update,
            format="json",
        )
    ...
    def test_logged_in_user_exam_no_delete(self):
        ...
        response = self.client.delete(
            reverse("kalanfa:core:exam-detail", kwargs={"pk": self.exam.id})
        )
    ...
    def test_can_get_quiz_size(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:exam-size"),
            {
