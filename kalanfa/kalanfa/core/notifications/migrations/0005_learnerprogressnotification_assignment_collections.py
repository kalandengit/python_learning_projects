...
def migrate_collection_ids(apps, schema_editor):
    try:
        ...
        LearnerGroup = apps.get_model("kalanfaauth", "LearnerGroup")
        AdHocGroup = apps.get_model("kalanfaauth", "AdHocGroup")
        LearnerGroupMap = {
            g["id"]: g["parent_id"]
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=kalanfa.core.fields.JSONField(default=[], null=True),
        ),
