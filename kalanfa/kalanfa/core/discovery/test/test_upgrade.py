...
from kalanfa.core.discovery.upgrade import move_network_location_entries
...
class TestNetworkLocationUpgrade(TestCase):
    ...
    def test_successful_move_locations(self):
        ...
        with patch(
            "kalanfa.core.discovery.upgrade.NetworkLocation"
        ) as mock_model, patch(
            "kalanfa.core.discovery.upgrade.connection"
        ) as mock_connection:
