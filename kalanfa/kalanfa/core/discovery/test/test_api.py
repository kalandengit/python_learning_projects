...
class NetworkLocationAPITestCase(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.existing_happy_netloc = models.NetworkLocation.objects.create(
            base_url="https://kalanfahappyurl.qqq/"
        )
        cls.existing_nonkalanfa_netloc = models.NetworkLocation.objects.create(
            base_url="https://nonkalanfahappyurl.qqq/"
        )
    ...
    def assert_network_location_list(self, syncable_value, expected_ids):
        ...
        response = self.client.get(
            reverse("kalanfa:core:networklocation-list"),
            params,
        )
    ...
    def test_get__pk(self):
        ...
        response = self.client.get(
            reverse(
                "kalanfa:core:staticnetworklocation-detail",
    ...
    def test_creating_good_address(self):
        ...
        response = self.client.post(
            reverse("kalanfa:core:staticnetworklocation-list"),
            data={"base_url": "kalanfahappyurl.qqq"},
            format="json",
        )
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(response.data["base_url"], "https://kalanfahappyurl.qqq/")
    ...
    def test_creating_bad_address(self):
        ...
        response = self.client.post(
            reverse("kalanfa:core:staticnetworklocation-list"),
            data={"base_url": "nonkalanfahappyurl.qqq"},
            format="json",
        )
    ...
    def test_reading_network_location_list(self):
        self.login(self.superuser)
        response = self.client.get(reverse("kalanfa:core:staticnetworklocation-list"))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_return_kdp_reserved_location(self):
        ...
        expected_ids = [
            ...
            self.existing_nonkalanfa_netloc.id,
    ...
    def test_update_connection_status(self):
        ...
        with mock.patch.object(
            ...
            try:
                self.client.post(
                    reverse(
                        "kalanfa:core:networklocation-update-connection-status",
...
class NetworkLocationFacilitiesViewTestCase(APITestCase):
    ...
    def _retrieve(self, payload):
        with mock.patch(
            "kalanfa.core.discovery.viewsets.network_location.NetworkClient"
        ) as NetworkClient:
            ...
            return self.client.get(
                reverse(
                    "kalanfa:core:networklocation_facilities-detail",
...
class PinnedDeviceAPITestCase(APITestCase):
    ...
    def test_add_pinned_device(self):
        ...
        """
        response = self.client.post(
            reverse("kalanfa:core:pinned_devices-list"),
    ...
    def test_delete_own_pinned_devices(self):
        ...
        response = self.client.delete(
            reverse("kalanfa:core:pinned_devices-detail", kwargs={"pk": my_pin.id}),
        )
    ...
    def test_delete_other_pinned_devices(self):
        ...
        response = self.client.delete(
            reverse("kalanfa:core:pinned_devices-detail", kwargs={"pk": other_pin.id}),
        )
