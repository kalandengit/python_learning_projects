...
EXPORT_FOLDER_NAME = "KALANFA_DATA"
...
def enumerate_mounted_disk_partitions():
    ...
    for drive in drive_list:
        ...
        datafolder = get_kalanfa_data_dir_path(path)

        # If the Kalanfa data directory has been manually created by the user,
        # check if the data directory is writable. Otherwise, check if the path
        # is writable so Kalanfa can create the data directory there.
...
def get_kalanfa_data_dir_path(folder):
    """
