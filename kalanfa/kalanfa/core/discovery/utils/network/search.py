...
from kalanfa.core.discovery.tasks import add_dynamic_network_location
from kalanfa.core.discovery.tasks import dispatch_broadcast_hooks
from kalanfa.core.discovery.tasks import generate_job_id
from kalanfa.core.discovery.tasks import remove_dynamic_network_location
from kalanfa.core.discovery.tasks import reset_connection_states
from kalanfa.core.discovery.tasks import TYPE_ADD
from kalanfa.core.discovery.tasks import TYPE_REMOVE
...
class NetworkLocationListener(KalanfaInstanceListener):
    """
