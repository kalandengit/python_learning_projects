...
class PingbackNotificationTestCase(APITestCase):
    ...
    def test_get_notification(self):
        response = self.client.get(
            reverse(
                "kalanfa:core:pingbacknotification-detail",
    ...
    def test_do_not_get_dismissed_notifications(self):
        ...
        response = self.client.get(reverse("kalanfa:core:pingbacknotification-list"))
        expected_output = (
...
class PingbackNotificationDismissedTestCase(APITestCase):
    ...
    def test_create_notification(self):
        response = self.client.post(
            reverse("kalanfa:core:pingbacknotificationdismissed-list"),
