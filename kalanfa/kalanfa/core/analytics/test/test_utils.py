...
from kalanfa.core.analytics.constants.nutrition_endpoints import PINGBACK
from kalanfa.core.analytics.constants.nutrition_endpoints import STATISTICS
from kalanfa.core.analytics.models import PingbackNotification
from kalanfa.core.analytics.utils import calculate_list_stats
from kalanfa.core.analytics.utils import create_and_update_notifications
from kalanfa.core.analytics.utils import extract_channel_statistics
from kalanfa.core.analytics.utils import extract_facility_statistics
from kalanfa.core.auth.constants import demographics
from kalanfa.core.auth.constants import facility_presets
...
from kalanfa.core.logger.utils import user_data

USER_CSV_PATH = "kalanfa/core/logger/management/commands/user_data.csv"
...
class FacilityStatisticsTestCase(BaseDeviceSetupMixin, TestCase):
    ...
    def test_regression_4606_no_usersessions(self):
        ...
        facility = self.facilities[0]
        # will raise an exception if we haven't addressed https://github.com/learningequality/kalanfa/issues/4606
        actual = extract_facility_statistics(facility)
