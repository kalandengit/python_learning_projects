...
class SoudContextTestCase(TestCase):
    ...
    def test_property__network_location__not_kalanfa(self):
...
class SoudRequestSyncHookHandlerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        get_all_user_ids = mock.patch("kalanfa.core.device.soud.get_all_user_ids")
        ...
        request_sync = mock.patch("kalanfa.core.device.soud.request_sync")
...
class SoudExecuteSyncsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        execute_sync = mock.patch("kalanfa.core.device.soud.execute_sync")
...
class SoudExecuteSyncTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.sync = mock.patch("kalanfa.core.device.soud.call_command")
