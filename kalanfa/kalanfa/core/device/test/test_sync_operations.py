...
from kalanfa.core.device.kalanfa_plugin import LearnerDeviceStatusOperation
...
class LearnerDeviceStatusOperationTestCase(TestCase):
    ...
    def test_handle__single_user_sync_server__downgrade(self):
        ...
        with mock.patch(
            "kalanfa.core.device.kalanfa_plugin.get_user_id_for_single_user_sync",
    ...
    def test_handle__full_facility_sync_server__downgrade(self):
        ...
        with mock.patch(
            ...
            "kalanfa.core.device.kalanfa_plugin.get_dataset_id",
