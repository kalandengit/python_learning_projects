...
from kalanfa.core.auth.models import AbstractFacilityDataModel
from kalanfa.core.auth.models import Facility
from kalanfa.core.auth.models import FacilityUser
from kalanfa.core.auth.permissions.base import RoleBasedPermissions
from kalanfa.core.auth.permissions.general import IsOwn
from kalanfa.core.content.utils.paths import using_remote_storage
...
from kalanfa.core.public.constants.user_sync_options import STALE_QUEUE_TIME
from kalanfa.core.utils.cache import process_cache as cache
...
from kalanfa.deployment.default.sqlite_db_names import SYNC_QUEUE
from kalanfa.utils.conf import OPTIONS
from kalanfa.utils.data import ChoicesEnum
from kalanfa.utils.options import update_options_file
...
class DeviceSettings(models.Model):
    ...
    # What is the default language that Kalanfa is displayed in for this device?
...
class SyncQueueRouter(KalanfaModelRouter):
    """
