"""
Kalanfa public url patterns
===========================

This module defines the "public API" endpoints that we expect to be called externally by other
instances of Kalanfa, or by 3rd party applications or clients. For this reason, these endpoints
need to be maintained with backwards compatibility to ensure ongoing support for older clients.

NOTE: These are the ONLY stable API endpoints in Kalanfa. All other API endpoints outside
...
from kalanfa.core.content.public_api import ImportMetadataViewset
