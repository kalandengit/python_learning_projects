...
def _session_list_url():
    return reverse("kalanfa:core:attendancesession-list")


def _session_detail_url(pk):
    return reverse("kalanfa:core:attendancesession-detail", kwargs={"pk": pk})


def _session_recent_url():
    return reverse("kalanfa:core:attendancesession-recent")


def _record_list_url():
    return reverse("kalanfa:core:attendancerecord-list")


def _record_bulk_update_url():
    return reverse("kalanfa:core:attendancerecord-bulk-update")
