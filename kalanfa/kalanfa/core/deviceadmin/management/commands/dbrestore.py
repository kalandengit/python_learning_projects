...
class Command(BaseCommand):
    ...
    # @ReservedAssignment
    help = (
        "Restores a database backup of Kalanfa. This is not intended for "
    ...
    def add_arguments(self, parser):
        ...
        parser_group.add_argument(
            ...
            dest="select",
            help=(
                "Show the list of the last 10 backups Kalanfa has done automatically "
    ...
    def fetch_latest(self, dumps_root):
        ...
        fallback_version = ".".join(kalanfa.__version__.split(".")[:2])
