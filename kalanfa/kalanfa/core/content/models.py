...
the generate_schema command should be run like this:
    ...
    `kalanfa manage generate_schema current`
...
from kalanfa.core.content.utils.search import bitmask_fieldnames
from kalanfa.core.content.utils.search import metadata_bitmasks
...
from kalanfa.core.mixins import FilterByUUIDQuerysetMixin
...
class ContentNode(base_models.ContentNode):
    ...
    # Fields used only on Kalanfa and not imported from a content database
    ...
    # This resource has been added to Kalanfa directly or
    ...
    # needs a subsequent Kalanfa upgrade step to backfill these values.
