...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        kalanfa manage importcontent --manifest /path/to/KALANFA_DATA/content/manifest.json disk
        """
        parser.add_argument(
            "--manifest",
        ...
        kalanfa manage importcontent --node_ids <id1>,<id2>, [<ids>,...] {network, disk} <channel id>
        """
        parser.add_argument(
            "--node_ids",
            "-n",
        ...
        kalanfa manage importcontent --exclude_node_ids <id1>,<id2>, [<ids>,...] {network, disk} <channel id>
        """
        parser.add_argument(
            "--exclude_node_ids",
            # Split the comma separated string we get, into a list of strings
        ...
        parser.add_argument(
            ...
            help="Import all content, not just that which this Kalanfa instance can render",
        )
