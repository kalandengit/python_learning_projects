...
class Command(BaseCommand):
    ...
    content that's not visible in Kalanfa.
    """

    help = "Scan content and databases in Kalanfa folder and updates the database to show if available"
    ...
    def add_arguments(self, parser):
        ...
        # useful for managing content extensions in the Kalanfa desktop
        # application.
        parser.add_argument(
            "--skip-annotations",
            required=False,
