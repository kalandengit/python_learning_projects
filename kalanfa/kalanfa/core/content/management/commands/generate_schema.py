...
from kalanfa.core.content.utils.channel_import import no_schema_models
from kalanfa.core.content.utils.sqlalchemybridge import __SQLALCHEMY_CLASSES_MODULE_NAME
from kalanfa.core.content.utils.sqlalchemybridge import __SQLALCHEMY_CLASSES_PATH
from kalanfa.core.content.utils.sqlalchemybridge import (
    coerce_version_name_to_valid_module_path,
)
from kalanfa.core.content.utils.sqlalchemybridge import get_default_db_string
from kalanfa.core.content.utils.sqlalchemybridge import prepare_base
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        app_name = KalanfaContentConfig.label
        ...
        if not no_export_schema:
            ...
            settings.INSTALLED_APPS = ("kalanfa.core.content.contentschema",)
        ...
        # Exclude channelmetadatacache in case we are reflecting an older version of Kalanfa
        table_names = [
        ...
        if not no_export_schema:
            ...
            os.system("kalanfa manage generate_schema " + CURRENT_SCHEMA_VERSION)
