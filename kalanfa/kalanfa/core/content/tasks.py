...
from kalanfa.core.content.models import ContentRequest
from kalanfa.core.content.models import ContentRequestPriority
from kalanfa.core.content.models import ContentRequestReason
from kalanfa.core.content.models import ContentRequestStatus
from kalanfa.core.content.models import ContentRequestType
...
from kalanfa.core.content.utils.content_delete import delete_content
...
from kalanfa.core.content.utils.resource_import import DiskChannelUpdateManager
...
from kalanfa.core.content.utils.resource_import import RemoteChannelUpdateManager
from kalanfa.core.content.utils.settings import automatic_download_enabled
from kalanfa.core.content.utils.upgrade import diff_stats
...
from kalanfa.core.discovery.utils.network.errors import IncompatibleVersionError
...
from kalanfa.core.tasks.job import default_status_text
    ...
    def validate(self, data):
        ...
        try:
            ...
            if client.device_info[
                "application"
            ] == "kalanfa" and not version_matches_range(
                client.device_info["kalanfa_version"], MIN_RESOURCE_IMPORT_VERSION
            ):
                raise IncompatibleVersionError(
                    "Remote Kalanfa instance must be 0.16.0 or higher"
                )
...
def remoteresourceimport(
    ...
    metadata_url = reverse_path(
        "kalanfa:core:importmetadata-detail", kwargs={"pk": node_id}
    )
