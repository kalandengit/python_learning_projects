...
from kalanfa.core.content.constants.schema_versions import CONTENT_DB_SCHEMA_VERSIONS
from kalanfa.core.content.constants.schema_versions import CURRENT_SCHEMA_VERSION
from kalanfa.core.mixins import UUIDValidationError
from kalanfa.core.mixins import validate_uuids
from kalanfa.core.sqlite.pragmas import CONNECTION_PRAGMAS
from kalanfa.core.sqlite.pragmas import START_PRAGMAS
from kalanfa.utils.sql_alchemy import db_matches_schema
from kalanfa.utils.sql_alchemy import DBSchemaError
...
def coerce_version_name_to_valid_module_path(name):
    ...
    # use Kalanfa versions explicitly in their name.
