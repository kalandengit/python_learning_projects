...
from kalanfa.core.discovery.utils.filesystem import enumerate_mounted_disk_partitions
...
def read_channel_metadata_from_db_file(channeldbpath):
    # import here to avoid circular imports whenever kalanfa.core.content.models imports utils too
