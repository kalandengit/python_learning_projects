...
from kalanfa.utils.server import get_zip_port
...
def get_content_database_dir_path(datafolder=None, contentfolder=None):
    ...
    ($HOME/.kalanfa/content/databases on POSIX systems, by default)
    """
    path = os.path.join(
...
def get_content_database_file_path(channel_id, datafolder=None, contentfolder=None):
    ...
    ($HOME/.kalanfa/content/databases/<channel_id>.sqlite3 on POSIX systems, by default)
    """
