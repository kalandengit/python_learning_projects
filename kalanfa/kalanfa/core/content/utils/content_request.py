...
from kalanfa.core.content.utils.assignment import ContentAssignmentManager
...
from kalanfa.core.content.utils.settings import allow_non_local_download
from kalanfa.core.content.utils.settings import get_free_space_for_downloads
...
from kalanfa.core.discovery.utils.network.connections import capture_connection_state
...
from kalanfa.utils.data import bytes_for_humans
from kalanfa.utils.file_transfer import ChunkedFileDirectoryManager
...
class PreferredDevices:
    ...
    of instance IDs, and a filter for the version of Kalanfa running on the server.
...
def _get_import_metadata(client, download):
    ...
    base_url = reverse_path(
        "kalanfa:core:importmetadata-detail", kwargs={"pk": contentnode_id}
    )
