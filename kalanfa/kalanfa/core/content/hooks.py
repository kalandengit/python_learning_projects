...
from kalanfa.core.webpack.hooks import WebpackInclusionMixin
...
@define_hook
class ContentNodeDisplayHook(KalanfaHook):
    """
...
@define_hook
class ShareFileHook(KalanfaHook):
    @abstractmethod
