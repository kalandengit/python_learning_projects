...
from kalanfa.core.content.utils.file_availability import (
...
class LocalFileByDisk(TransactionTestCase):
    ...
    @patch("kalanfa.core.content.utils.file_availability.get_mounted_drive_by_id")
...
class LocalFileRemote(TransactionTestCase):
    ...
    @patch("kalanfa.core.content.utils.file_availability.NetworkClient")
