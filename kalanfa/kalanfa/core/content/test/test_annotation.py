...
from kalanfa.core.content.utils.annotation import calculate_published_size
from kalanfa.core.content.utils.annotation import calculate_total_resource_count
from kalanfa.core.content.utils.annotation import mark_local_files_as_available
from kalanfa.core.content.utils.annotation import mark_local_files_as_unavailable
...
from kalanfa.core.content.utils.annotation import set_leaf_nodes_invisible
from kalanfa.core.content.utils.annotation import set_local_file_availability_from_disk
...
class LocalFileByDisk(TransactionTestCase):
    ...
    @patch(
        "kalanfa.core.content.utils.annotation.get_content_storage_file_path",
