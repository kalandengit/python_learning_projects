...
from kalanfa.core.content.constants.kind_to_learningactivity import kind_activity_map
from kalanfa.core.content.constants.schema_versions import CONTENT_SCHEMA_VERSION
from kalanfa.core.content.constants.schema_versions import NO_VERSION
from kalanfa.core.content.constants.schema_versions import V020BETA1
from kalanfa.core.content.constants.schema_versions import V040BETA3
from kalanfa.core.content.constants.schema_versions import VERSION_1
from kalanfa.core.content.constants.schema_versions import VERSION_2
from kalanfa.core.content.constants.schema_versions import VERSION_3
from kalanfa.core.content.constants.schema_versions import VERSION_4
from kalanfa.core.content.models import AssessmentMetaData
from kalanfa.core.content.models import ChannelMetadata
from kalanfa.core.content.models import ContentNode
from kalanfa.core.content.models import ContentTag
...
from kalanfa.core.content.utils.annotation import recurse_annotation_up_tree
from kalanfa.core.content.utils.annotation import (
    set_leaf_node_availability_from_local_file_availability,
)
from kalanfa.core.content.utils.annotation import update_content_metadata
from kalanfa.core.content.utils.channel_import import BATCH_SIZE
from kalanfa.core.content.utils.channel_import import ChannelImport
from kalanfa.core.content.utils.channel_import import import_channel_from_data
from kalanfa.core.content.utils.channel_import import import_channel_from_local_db
from kalanfa.core.content.utils.channel_import import topological_sort
...
@patch("kalanfa.core.content.utils.channel_import.Bridge")
@patch("kalanfa.core.content.utils.channel_import.ChannelImport.find_unique_tree_id")
@patch("kalanfa.core.content.utils.channel_import.apps")
class BaseChannelImportClassConstructorTestCase(TestCase):
    ...
    @patch("kalanfa.core.content.utils.channel_import.get_content_database_file_path")
...
@patch("kalanfa.core.content.utils.channel_import.Bridge")
@patch(
    "kalanfa.core.content.utils.channel_import.ChannelImport.get_all_destination_tree_ids"
)
@patch("kalanfa.core.content.utils.channel_import.apps")
...
class BaseChannelImportClassOtherMethodsTestCase(TestCase):
    ...
    @patch("kalanfa.core.content.utils.channel_import.select")
...
class MaliciousDatabaseTestCase(TestCase):
    @patch("kalanfa.core.content.utils.channel_import.set_channel_ancestors")
    @patch("kalanfa.core.content.utils.channel_import.Bridge")
    @patch("kalanfa.core.content.utils.channel_import.select")
...
class ContentImportTestBase(TransactionTestCase):
    ...
    def set_content_fixture(self, db_path_mock):
        ...
        with patch(
            "kalanfa.core.content.utils.sqlalchemybridge.get_engine",
            new=self.get_engine,
        ):
...
class ImportLongDescriptionsTestCase(ContentImportTestBase, TransactionTestCase):
    ...
    https://github.com/learningequality/kalanfa/issues/3600
    """
...
@patch("kalanfa.core.content.utils.channel_import.Bridge")
@patch("kalanfa.core.content.utils.channel_import.logger")
@patch("kalanfa.core.content.utils.channel_import.select")
@patch("kalanfa.core.content.utils.channel_import.apps")
