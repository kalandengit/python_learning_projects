...
from kalanfa.core.content.utils.content_manifest import ContentManifestParseError
from kalanfa.core.content.utils.content_manifest import get_content_nodes_selectors
...
class ContentManifestTestCase(TestCase):
    ...
    @patch("kalanfa.core.content.utils.content_manifest.get_content_nodes_selectors")
