...
@patch("kalanfa.core.content.management.commands.content.update_options_file")
class ContentMoveDirectoryTestCase(TestCase):
    """
    Testcase for the command kalanfa manage content movedirectory <destination>
    """
    ...
    @patch("kalanfa.core.content.management.commands.content.Command.migrate")
    @patch(
        "kalanfa.core.content.management.commands.content.os.path.exists",
        return_value=False,
    )
    ...
    @patch("kalanfa.core.content.management.commands.content.Command.migrate")
    @patch("kalanfa.utils.server.get_status", return_value=True)
    @patch(
        "kalanfa.core.content.management.commands.content.os.path.exists",
        return_value=True,
    )
    def test_migrate_while_kalanfa_running(
    ...
    @patch("kalanfa.core.content.management.commands.content.shutil.rmtree")
    @patch("kalanfa.core.content.management.commands.content.shutil.copy2")
    @patch("kalanfa.core.content.management.commands.content.input", return_value="no")
    @patch(
        "kalanfa.core.content.management.commands.content.os.listdir",
    ...
    @patch("kalanfa.core.content.management.commands.content.Command.copy_content")
    @patch("kalanfa.core.content.management.commands.content.shutil.rmtree")
    @patch("kalanfa.core.content.management.commands.content.input", return_value="yes")
    @patch(
        "kalanfa.core.content.management.commands.content.os.listdir",
        return_value=["test"],
    )
    ...
    @patch(
        "kalanfa.core.content.management.commands.content.Command.update_config_content_directory"
    )
    @patch(
        "kalanfa.core.content.management.commands.content.input", return_value="random"
    )
    @patch(
        "kalanfa.core.content.management.commands.content.os.listdir",
        return_value=["test"],
    ...
    @patch("kalanfa.core.content.management.commands.content.shutil.rmtree")
    @patch("kalanfa.core.content.management.commands.content.shutil.copystat")
    @patch("kalanfa.core.content.management.commands.content.os.makedirs")
    @patch(
        "kalanfa.core.content.management.commands.content.os.listdir", return_value=[]
    )
    @patch(
        "kalanfa.core.content.management.commands.content.os.path.exists",
