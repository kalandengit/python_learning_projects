...
from kalanfa.core.content.utils.sqlalchemybridge import ClassNotFoundError
from kalanfa.core.content.utils.sqlalchemybridge import get_class
from kalanfa.core.content.utils.sqlalchemybridge import get_default_db_string
from kalanfa.core.content.utils.sqlalchemybridge import get_engine
from kalanfa.core.content.utils.sqlalchemybridge import set_all_class_defaults
from kalanfa.core.content.utils.sqlalchemybridge import sqlite_connection_string


@patch("kalanfa.core.content.utils.sqlalchemybridge.db_matches_schema")
@patch(
    "kalanfa.core.content.utils.sqlalchemybridge.sqlite_connection_string",
    return_value="sqlite://",
)
class SQLAlchemyBridgeClassTestCase(TestCase):
    ...
    @patch(
        "kalanfa.core.content.utils.sqlalchemybridge.get_default_db_string",
    ...
    @patch("kalanfa.core.content.utils.sqlalchemybridge.get_class")
...
@patch("kalanfa.core.content.utils.sqlalchemybridge.get_class")
@patch("kalanfa.core.content.utils.sqlalchemybridge.apps")
class SQLAlchemyBridgeSetDefaultsTestCase(TestCase):
    ...
    @patch("kalanfa.core.content.utils.sqlalchemybridge.ColumnDefault")
