...
from kalanfa.core.content.upgrade import import_external_content_dbs
from kalanfa.core.content.utils.channels import get_channel_ids_for_content_database_dir
from kalanfa.core.content.utils.channels import get_channels_for_data_folder
from kalanfa.core.content.utils.paths import get_content_database_dir_path
...
class EnumerateChannelTestCase(TestCase):
    ...
    @patch("kalanfa.core.content.upgrade.update_num_coach_contents")
    @patch("kalanfa.core.content.upgrade.logger.warning")
