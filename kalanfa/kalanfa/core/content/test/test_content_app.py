"""
To run this test, type this in command line <kalanfa manage test -- kalanfa.core.content>
"""
...
from kalanfa.core.content import models as content
from kalanfa.core.content.api import NUM_CHILDREN
from kalanfa.core.content.test.helpers import ChannelBuilder
from kalanfa.core.content.utils.paths import get_v2_channel_lookup_url
...
class ContentNodeAPIBase:
    ...
    def test_contentnode_list(self):
        ...
        response = self._get(reverse("kalanfa:core:contentnode-list"))
    ...
    def test_contentnode_channel_metadata_label_absent_in_internal_api(self):
        response = self._get(
            reverse("kalanfa:core:contentnode-list"), data={"max_results": 5}
        )
    ...
    def test_contentnode_channel_metadata_label_present_in_public_api(self):
        response = self._get(
            reverse("kalanfa:core:publiccontentnode-list"), data={"max_results": 5}
        )
        self.assertEqual(response.status_code, 200)
        self.assertIn("channels", response.data.get("labels"))
    ...
    def test_contentnode_etag(self):
        ...
        url = reverse("kalanfa:core:contentnode-list")
    ...
    def test_contentnode_tree(self):
        root = content.ContentNode.objects.get(title="root")
        response = self._get(
            reverse("kalanfa:core:contentnode_tree-detail", kwargs={"pk": root.id})
        )
    ...
    def test_contentnode_tree_bad_pk(self):
        response = self.client.get(
            reverse(
                "kalanfa:core:contentnode_tree-detail",
...
class ContentNodeAPITestCase(ContentNodeAPIBase, APITestCase):
    ...
    def test_prerequisite_for_filter(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode-list"), data={"prerequisite_for": c1_id}
        )
    ...
    def test_has_prerequisite_filter(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode-list"), data={"has_prerequisite": root_id}
        )
    ...
    def test_related_filter(self):
        c1_id = content.ContentNode.objects.get(title="c1").id
        response = self.client.get(
            reverse("kalanfa:core:contentnode-list"), data={"related": c1_id}
        )
        self.assertEqual(response.data[0]["title"], "c2")

    @mock.patch("kalanfa.core.content.api.get_channel_stats_from_studio")
    def test_contentnode_granular_network_import(self, stats_mock):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode_granular-detail", kwargs={"pk": c1_id})
        )
    ...
    @mock.patch("kalanfa.core.content.api.get_channel_stats_from_disk")
    ...
    @mock.patch("kalanfa.core.content.api.get_channel_stats_from_peer")
    ...
    def test_contentnode_granular_includes_modality(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode_granular-detail", kwargs={"pk": c1.id}),
            data={"for_export": True},
        )
    ...
    def test_contentnode_retrieve(self):
        c1_id = content.ContentNode.objects.get(title="c1").id
        response = self.client.get(
            reverse("kalanfa:core:contentnode-detail", kwargs={"pk": c1_id})
        )
    ...
    def test_contentnode_descendants_assessments_exercise_node(self):
        ...
        c1_id = c1.id
        response = self.client.get(
            reverse("kalanfa:core:contentnode-descendants-assessments"),
            data={"ids": c1_id},
        )
        self.assertEqual(
            next(
    ...
    def test_contentnode_recommendations(self):
        ...
        response = self.client.get(
            reverse(
                "kalanfa:core:contentnode-recommendations-for", kwargs={"pk": node_id}
            )
        )
    ...
    def test_contentnode_ids(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode-list"),
    ...
    def test_contentnode_tags(self):
        ...
        for title, tags in expected.items():
            ...
            response = self.client.get(
                reverse("kalanfa:core:contentnode-detail", kwargs={"pk": node.id})
            )
            self.assertEqual(set(response.data["tags"]), set(tags))

    def test_channelmetadata_list(self):
        response = self.client.get(reverse("kalanfa:core:channel-list", kwargs={}))
    ...
    def test_channelmetadata_retrieve(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:channel-detail", kwargs={"pk": data["id"]})
        )
    ...
    def test_channelmetadata_content_available_param_filter_lowercase_true(self):
        response = self.client.get(
            reverse("kalanfa:core:channel-list"), {"available": "true"}
        )
    ...
    def test_channelmetadata_content_unavailable_param_filter_false(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:channel-list"), {"available": False}
        )
        self.assertEqual(response.data[0]["id"], "6199dde695db4ee4ab392222d5af1e5c")

    def test_channelmetadata_content_available_field_true(self):
        response = self.client.get(reverse("kalanfa:core:channel-list"))
    ...
    def test_channelmetadata_contains_exercise_filter(self):
        ...
        no_filter_response = self.client.get(reverse("kalanfa:core:channel-list"))
        self.assertEqual(len(no_filter_response.data), 2)
        with_filter_response = self.client.get(
            reverse("kalanfa:core:channel-list"), {"contains_exercise": True}
        )
    ...
    def test_channelmetadata_contains_quiz_filter(self):
        ...
        with_filter_response = self.client.get(
            reverse("kalanfa:core:channel-list"), {"contains_quiz": True}
        )
        self.assertEqual(len(with_filter_response.data), 1)
    ...
    def test_channelmetadata_contains_quiz_filter_false(self):
        ...
        baseline = self.client.get(reverse("kalanfa:core:channel-list"))
        ...
        false_response = self.client.get(
            reverse("kalanfa:core:channel-list"), {"contains_quiz": "false"}
        )
    ...
    def test_file_list(self):
        response = self.client.get(reverse("kalanfa:core:file-list"))
        self.assertEqual(len(response.data), 10)

    def test_file_retrieve(self):
        response = self.client.get(
            reverse(
                "kalanfa:core:file-detail",
    ...
    def test_contentnode_progress_list_endpoint(self):
        ...
        response = self.client.get(reverse("kalanfa:core:contentnodeprogress-list"))
    ...
    def test_search_total_results(self):
        response = self.client.get(
            reverse("kalanfa:core:contentnode_search-list"), data={"search": "root"}
        )
    ...
    def test_search_repeated_kinds(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode_search-list"), data={"search": "c"}
        )
    ...
    def test_search(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:contentnode_search-list"), data={"search": "!?,"}
        )
        self.assertEqual(len(response.data["results"]), 0)
        # ensure search words when there is only stopwords
        response = self.client.get(
            reverse("kalanfa:core:contentnode_search-list"), data={"search": "or"}
        )
        self.assertEqual(len(response.data["results"]), 0)
        # regular search
        response = self.client.get(
    ...
    def test_popular(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:usercontentnode-list"), data={"popular": True}
        )
    ...
    def test_popular_no_coach_content(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:usercontentnode-list"),
    ...
    def test_resume(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:usercontentnode-list"), data={"resume": True}
        )
        response_content_ids = {node["content_id"] for node in response.json()}
        self.assertSetEqual(set(expected_content_ids), response_content_ids)
    ...
    def test_next_steps_prereq(self):
        ...
        response = self.client.get(
            reverse("kalanfa:core:usercontentnode-list"), data={"next_steps": True}
        )
        response_content_ids = {node["content_id"] for node in response.json()}
        self.assertSetEqual(set(expected_content_ids), response_content_ids)
    ...
    def test_lesson_filter(self):
        ...
        self.client.login(username=user.username, password=DUMMY_PASSWORD)
        response = self.client.get(
            reverse("kalanfa:core:usercontentnode-list"), data={"lesson": own_lesson.id}
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
    ...
    def test_remote_content_node_missing_attributes(self):
        with mock.patch("kalanfa.core.content.api.NetworkClient") as nc:
            ...
            response = self.client.get(
                reverse("kalanfa:core:contentnode-detail", kwargs={"pk": expected.id}),
...
class KalanfaStudioAPITestCase(APITestCase):
    databases = "__all__"
    ...
    def test_channel_list(self):
        response = self.client.get(
            reverse("kalanfa:core:remotechannel-list"), format="json"
        )
    ...
    def test_channel_retrieve(self):
        response = self.client.get(
            reverse("kalanfa:core:remotechannel-detail", kwargs={"pk": "abc"}),
            format="json",
        )
    ...
    def test_community_channel_retrieve_response_failure_without_response(self):
        ...
        with mock.patch.object(
            ...
            response = self.client.get(
                reverse(
                    "kalanfa:core:remotechannel-detail",
...
class ChannelThumbnailViewTestCase(APITestCase):
    ...
    def test_channel_thumbnail_view(self):
        response = self.client.get(
            reverse("kalanfa:core:channel-thumbnail", args=[self.channel_metadata.id])
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_channel_thumbnail_view_not_found(self):
        response = self.client.get(
            reverse("kalanfa:core:channel-thumbnail", args=["deadpool"])
        )
        self.assertEqual(response.status_code, 404)
...
class ShareFileViewTestCase(APITestCase):
    ...
    def test_post_returns_static_error_code_on_hook_failure(self):
        ...
        with mock.patch(
            "kalanfa.core.device.permissions.valid_app_key_on_request",
            return_value=True,
        ), mock.patch(
            "kalanfa.core.content.api.ShareFileHook.execute_file_share",
            side_effect=Exception("internal server path /secrets/file"),
        ):
            response = self.client.post(
                reverse("kalanfa:core:sharefile"),
