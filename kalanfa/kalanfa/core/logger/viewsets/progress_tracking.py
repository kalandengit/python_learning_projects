...
from kalanfa.core.logger.constants.exercise_attempts import MAPPING
...
from kalanfa.core.notifications.tasks import wrap_to_save_queue
    ...
    def _get_or_create_masterylog(
        ...
        if masterylog is None or (masterylog.complete and repeat):
            ...
            if is_quiz:
                ...
                # Kalanfa versions, we use negative mastery levels for these.
                ...
                # In older versions of Kalanfa the mastery_level is validated to be
