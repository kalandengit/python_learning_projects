...
#   pytest kalanfa/core/analytics/test/test_utils.py
#   pytest kalanfa/core/logger/utils/user_data.py
#####################
...
def logger_info(message, verbosity=1):
    ...
    # doesn't work on Windows, see: https://github.com/learningequality/kalanfa/issues/7077
    try:
