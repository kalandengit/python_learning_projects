...
engagement with content and the Kalanfa app.
...
class UserSessionLog(BaseLogModel):
    """
    This model provides a record of a user session in Kalanfa.
    """
...
class MasteryLog(BaseLogModel):
    ...
    # of Kalanfa prior to this being added and zero values.
    time_spent = models.FloatField(
