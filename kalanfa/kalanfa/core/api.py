"""
Kalanfa API base classes and utilities.

IMPORTANT: Most Kalanfa APIs are internal and unstable, designed for Kalanfa's own use.
...
See kalanfa/core/public/api_urls.py for the public API definitions.
...
from kalanfa.core.auth.tasks import enqueue_automatic_kdp_sync
...
from kalanfa.core.utils.serializer_introspection import derive_values_from_serializer
from kalanfa.core.utils.serializer_introspection import normalize_field_map
from kalanfa.core.utils.serializer_introspection import ValuesMethodField  # noqa: F401
...
class KalanfaDataPortalViewSet(viewsets.ViewSet):
