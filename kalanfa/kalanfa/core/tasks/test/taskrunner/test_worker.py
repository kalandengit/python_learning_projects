...
from kalanfa.core.tasks.test.taskrunner.test_job_running import EventProxy
...
class TestWorker:
    ...
    def test_can_handle_unicode_exceptions(self, worker):
        ...
        # See Storage.mark_job_as_failed in kalanfa.core.tasks.storage for more details on why we do this.

        # create a job that triggers an exception
        job = Job("kalanfa.core.tasks.test.taskrunner.test_worker.error_func")
