...
class TestRegisteredTask(TestCase):
    ...
    @mock.patch("kalanfa.core.tasks.registry.Job", spec=True)
    ...
    @mock.patch("kalanfa.core.tasks.registry.RegisteredTask._ready_job")
    @mock.patch("kalanfa.core.tasks.registry.job_storage")
