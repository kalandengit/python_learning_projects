...
from kalanfa.core.tasks.exceptions import JobNotRestartable
...
from kalanfa.core.tasks.validation import validate_exception
...
class Storage:
    ...
    def _sqlite_next_queued_job(self, priority, supervisor_id):
        """
        SQLite cannot lock individual rows, but Kalanfa's custom SQLite
