...
# For these scenarios you will need another Kalanfa running on a discoverable device in the same LAN

  Background:
    Given I am signed in to Kalanfa <instance1> as a super admin user
      And I am signed in to Kalanfa <instance2> as a super admin user
  ...
  Scenario: Another Kalanfa instance is unable to import my unlisted channels
  ...
  Scenario: Another Kalanfa instance is able to import my unlisted channels
...
| Kalanfa A | Kalanfa B | 192.168.0.5      | 192.168.0.6      | MIT Blossoms   | My Private Channel |
