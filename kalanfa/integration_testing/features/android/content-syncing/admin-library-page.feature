Feature: My downloads - Library page
  ...
  Background:
	...
	Scenario: Super admin is able to see Kalanfa Studio libraries
		When I load the *Learn > Library* page
			And I look at the *Other libraries* section of the page
		Then I see the *Kalanfa content library* section
	...
	Scenario: Super admin goes to Kalanfa Studio
		Given I see the *Kalanfa content library* section
		When I click *Explore this library*
		Then I go to the main library page for Kalanfa Studio
