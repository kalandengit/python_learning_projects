 Feature: Windows app installation
  A user needs to be able to install Kalanfa on a supported Windows 7, 8.1 and 10 device

  Background:
    Given that I have downloaded the kalanfa-v0.16-windows-setup.exe file on a supported Windows device
