Feature: Kalanfa critical workflows
  This is a test suite of the main Kalanfa workflows.
  ...
  Scenario: Users can sign in and sign out
  	Given I am at the Kalanfa sign-in page
  	...
  	Then I see *You must be signed in to view this page*
  		And I see a link *Sign in to Kalanfa*
