Feature: Quiz notifications
  ...
  Background:
    Given I am signed in to Kalanfa as a class coach
      And as a coach I have assigned a quiz to the entire class and started it
  ...
  Scenario: Class activity - Coach sees a notification that a learner has started the quiz
  	...
  	Then I see a *'<learner>' started '<quiz>'* notification
  ...
  Scenario: Class activity - Coach sees a notification that a learner has completed the quiz
  	Given the coach is at *Coach > '<class>' > Class Home* page
  		And the learner has just submitted the quiz at *Learn > Class > <class>*
  	When as a coach I look into the *Class activity* section
  	Then I see a *'<learner>' completed '<quiz>'* notification
  	When I click the notification link
  ...
  Scenario: Class activity - Coach sees a notification that everyone from the class has started/completed the quiz
  	Given the coach is at *Coach > '<class>' > Class Home* page
  		And all the learners in the class have started filling in the quiz at *Learn > Class > <class>*
  	When as a coach I look into the *Class activity* section
  	Then I see an *Everyone started '<quiz>'* notification
  	When I click the notification link
  	Then I see the quiz report for the learners
  	  And I see the correctly updated quiz data such as status, score, questions answered, time spent and attempted
  	  And I see the correct answer history and question details
  	When all the learners in the class have submitted the quiz at *Learn > Class > <class>*
  		And as a coach I look into the *Class activity* section
  	Then I see an *Everyone completed '<quiz>'* notification
  	When I click the notification link
  	Then I see the quiz report for the learners
  	  And I see the correctly updated quiz data such as status, score, questions answered, time spent and attempted
  	  And I see the correct answer history and question details

  Scenario: Quizzes section - Coach sees a notification that a learner has started the quiz
  	Given the coach is at *Coach > '<class>' > Class Home* page
  		And the learner has started filling in the quiz at *Learn > Class > <class>*
  ...
  Scenario: Quizzes section - Coach sees a notification that a learner has completed the quiz
  	Given the coach is at *Coach > '<class>' > Class Home* page
