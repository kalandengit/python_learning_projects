Feature: kalanfa-server handles correctly content provided under file streams
  Some of the kalanfa contents are not actual files but streams, they must be correctly handled
  Background:
