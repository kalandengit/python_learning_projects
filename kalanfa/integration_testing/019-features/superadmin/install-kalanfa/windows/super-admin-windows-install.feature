 Feature: Windows app installation
  A user needs to be able to install Kalanfa on a supported Windows 7, 8.1, 10 and 11 device

  Background:
    Given that I have downloaded the kalanfa-0.19-windows-setup.exe file on a supported Windows device
