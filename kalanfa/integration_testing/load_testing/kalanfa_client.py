"""
HTTP client for interacting with Kalanfa APIs.
...
class CSRFAdapter(HTTPAdapter):
    ...
    def add_headers(self, request, **kwargs):
        ...
        if request.method in ("POST", "PUT", "PATCH", "DELETE"):
            ...
            csrf_token = request._cookies.get("kalanfa_csrftoken")
            if csrf_token:
                request.headers["X-CSRFToken"] = csrf_token


class KalanfaClient:
    """Client for interacting with Kalanfa REST APIs"""

    def __init__(self, base_url, username=None, password=None):
        """
        Initialize Kalanfa client.

        Args:
            base_url: Base URL of Kalanfa server (e.g., 'http://localhost:8000')
    ...
    def get_device_info(self):
        """
        Get device information including Kalanfa version.

        Returns:
            dict: Device info with kalanfa_version, application, etc.
        """
    ...
    def import_users_csv(self, csv_content, facility_id):
        ...
        data = {
            "type": "kalanfa.core.auth.tasks.importusersfromcsv",
    ...
    def import_channel(self, channel_id):
        ...
        Args:
            ...
            baseurl: Source URL (default: Kalanfa Studio)
        ...
        payload = {
            ...
            "channel_name": "Kalanfa QA Channel",
        }
