...
AUTHENTICATION_BACKENDS = [
    "kalanfa_oidc_client_plugin.auth.OIDCKalanfaAuthenticationBackend"
]
OIDC_OPTIONS = OPTIONS["OIDCClient"]
OIDC_URL = OIDC_OPTIONS["PROVIDER_URL"]
OIDC_RP_CLIENT_ID = os.environ.get("CLIENT_ID", "kalanfa.app")
OIDC_RP_CLIENT_SECRET = os.environ.get("CLIENT_SECRET", "kalanfa.app")
