...
"""
Usage example:
kalanfa manage oidccreateclient  --name="hooooo" --redirect-uri="http://otro/callback"
"""


class Command(BaseCommand):
    help = "Command to add new clients applications that will use kalanfa as an OpenID Connect provider"
