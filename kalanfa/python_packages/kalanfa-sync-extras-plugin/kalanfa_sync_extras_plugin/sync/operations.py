...
from kalanfa_sync_extras_plugin.sync.context import BackgroundSessionContext
from kalanfa_sync_extras_plugin.tasks import get_job_id
from kalanfa_sync_extras_plugin.tasks import set_job_id
...
class BackgroundInitializeJobOperation(BackgroundJobOperation):
    ...
    thread, but only if the client supports async operations (Kalanfa 0.15+)
    """
