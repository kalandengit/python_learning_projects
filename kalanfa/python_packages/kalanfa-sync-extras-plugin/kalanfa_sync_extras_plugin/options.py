...
option_spec = {
    "Sync": {
        "BACKGROUND_INITIALIZATION": {
            "type": "boolean",
            "default": False,
            "envvars": ("KALANFA_SYNC_BACKGROUND_INITIALIZATION",),
        },
        "BACKGROUND_INITIALIZATION_STAGES": {
            "type": "string",
            "default": ",".join([transfer_stages.SERIALIZING, transfer_stages.QUEUING]),
            "envvars": ("KALANFA_SYNC_BACKGROUND_INITIALIZATION_STAGES",),
        },
        "BACKGROUND_FINALIZATION": {
            "type": "boolean",
            "default": False,
            "envvars": ("KALANFA_SYNC_BACKGROUND_FINALIZATION",),
        },
        "BACKGROUND_FINALIZATION_STAGES": {
            ...
            "envvars": ("KALANFA_SYNC_BACKGROUND_FINALIZATION_STAGES",),
        },
    }
}
