...
from kalanfa_sync_extras_plugin.sync.operations import BackgroundFinalizeJobOperation
from kalanfa_sync_extras_plugin.sync.operations import BackgroundInitializeJobOperation
from kalanfa_sync_extras_plugin.sync.operations import BackgroundJobOperation
from kalanfa_sync_extras_plugin.sync.operations import BackgroundSessionContext
from kalanfa_sync_extras_plugin.sync.operations import SyncExtrasLocalOperation
...
class SyncExtrasLocalOperationTestCase(BaseTestCase):
    ...
    @mock.patch("kalanfa_sync_extras_plugin.sync.operations.OPTIONS")
...
class BackgroundJobOperationTestCase(BaseTestCase):
    @mock.patch("kalanfa_sync_extras_plugin.sync.operations.set_job_id")
    @mock.patch("kalanfa_sync_extras_plugin.sync.operations.job_storage")
    @mock.patch("kalanfa_sync_extras_plugin.sync.operations.get_job_id")
...
class BackgroundInitializeJobOperationTestCase(BaseTestCase):
    def setUp(self):
        ...
        mock_options = mock.patch("kalanfa_sync_extras_plugin.sync.operations.OPTIONS")
