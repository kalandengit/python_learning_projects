...
.. tip:: Make a “baseline” snapshot of your VM prior to installing  Kalanfa the first time

After you’ve tuned and optimized your VM and installed browsers, make one **Snapshot** before you install Kalanfa. This will be your baseline VM snapshot upon which you will install each Kalanfa version and restore to it to install the next one.

.. image:: ./install_kalanfa_01.png
...
1. Download this small testing channel, or others:
   ...
   * ``nakav-mafak`` - Kalanfa QA Channel (~250MB)

2. Use the following command to create Kalanfa users for testing.

   .. code-block:: bash

      kalanfa manage generateuserdata

   command to create Kalanfa users for testing.
...
.. _`recommended format`: https://github.com/learningequality/kalanfa/issues/new
