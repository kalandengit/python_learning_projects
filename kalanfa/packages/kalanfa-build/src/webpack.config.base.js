...
module.exports = ({ mode = 'development', hot = false, cache = false, transpile = false } = {}) => {
  ...
  if (transpile) {
    rules.push({
      ...
      options: {
        env: {
          targets: require('browserslist-config-kalanfa'),
        },
        jsc: {
          parser: {
            syntax: 'ecmascript',
  ...
  return {
    ...
    resolve: {
      ...
      modules: [
        ...
        // access kalanfa-build/node_modules modules during bundling.
        base_dir,
    ...
    resolveLoader: {
      modules: [
        ...
        // access kalanfa-build/node_modules loaders during bundling.
        base_dir,
        path.join(base_dir, 'node_modules'),
      ],
    },
