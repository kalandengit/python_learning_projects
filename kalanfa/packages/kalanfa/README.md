This is the kalanfa JS public API. All the exports and 'exposes' fields in the package.json are available at runtime as part of the Kalanfa core bundle, so JS built with the Kalanfa webpack configuration will defer to a global object to read these modules at runtime.
