...
import coreStore from 'kalanfa/store';
...
import useSnackbar, { useSnackbarMock } from 'kalanfa/composables/useSnackbar'; // eslint-disable-line
import { ref } from 'vue';
import { DisconnectionErrorCodes } from 'kalanfa/constants';
import { HeartBeat } from '../heartbeat.js';
import { trs } from '../internal/disconnection';
import coreModule from '../../../kalanfa/core/frontend/state/modules/core';
...
jest.mock('kalanfa/utils/browserInfo', () => {
  const actual = jest.requireActual('kalanfa/utils/browserInfo');
