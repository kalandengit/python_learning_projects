...
describe('UrlResolver', () => {
  ...
  describe('Special URL methods', () => {
    ...
    beforeEach(() => {
      ...
      window.location = new URL('http://kalanfa.time');
    });
    ...
    it('generates static URLs', () => {
      expect(Urls.static('js/bundle.js')).toBe('http://kalanfa.time/static/js/bundle.js');
    });

    it('generates media URLs', () => {
      expect(Urls.media('images/logo.png')).toBe('http://kalanfa.time/media/images/logo.png');
    });
    ...
    it('generates storage URLs', () => {
      expect(Urls.storageUrl('abc123', 'mp4')).toBe('http://kalanfa.time/content/a/b/abc123.mp4');
    });
