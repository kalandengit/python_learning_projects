...
export class Resource {
  ...
  constructor({ name, idKey = 'id', namespace = 'core', ...options } = {}) {
    ...
    this.name = `kalanfa:${namespace}:${name}`;
    this.idKey = idKey;
  ...
  client(options) {
    ...
    const client = require('kalanfa/client').default;
    return client(options);
  }

  logError(err) {
    // eslint-disable-next-line import-x/no-commonjs
    const router = require('kalanfa/router').default;
    if (!err.config) {
      return;
    }
