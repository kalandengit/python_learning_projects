...
import Subjects from 'kalanfa-constants/labels/Subjects';
...
import PICTURE_PASSWORD_SET from '../../kalanfa/core/auth/constants/picture_passwords_set.json';
// coach-facing
export { default as ContentNodeResourceType } from 'kalanfa-constants/labels/ResourceType';
export { default as LearningActivities } from 'kalanfa-constants/labels/LearningActivities';
export { default as AccessibilityCategories } from 'kalanfa-constants/labels/AccessibilityCategories';
// Used to categorize the level or audience of content
export { default as ContentLevels } from 'kalanfa-constants/labels/Levels';
export { default as ResourcesNeededTypes } from 'kalanfa-constants/labels/Needs';
export { default as Categories } from 'kalanfa-constants/labels/Subjects';
...
export const ERROR_CONSTANTS = {
  // These are an exact copy of the python module kalanfa.core.error_constants
...
// kalanfa/core/exams/constants.py
