...
export const trs = createTranslator('DisconnectionSnackbars', {
  disconnected: {
    ...
    context:
      'Message that indicates when Kalanfa is disconnected from a server. It also displays the time in countdown format that it will waiting until attempting to connect again.',
  },
  tryNow: {
    message: 'Try now',
    context:
      'Prompt indicating to the user that they should try again to reconnect Kalanfa with the server.',
  },
  tryingToReconnect: {
    message: 'Trying to reconnect…',
    context:
      'Message which displays while Kalanfa is trying to reconnect with the server following a disconnection.',
  },
  successfullyReconnected: {
    message: 'Successfully reconnected!',
    context: 'Message indicating that Kalanfa has been able to connect with the server again.',
  },
});
