...
import { browser, os } from 'kalanfa/utils/browserInfo';
import { setServerTime } from 'kalanfa/utils/serverClock';
...
import { LoginErrors, ERROR_CONSTANTS, UPDATE_MODAL_DISMISSED, UserKinds } from 'kalanfa/constants';
 ...
 * @property {import('vue').ComputedRef<boolean>} isAppContext - Whether Kalanfa is running inside
...
export default function useUser() {
  ...
  function logout() {
    redirectBrowser(urls['kalanfa:core:logout']());
  }
