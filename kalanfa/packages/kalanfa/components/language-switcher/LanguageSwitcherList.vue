...
<script>
  ...
  import { availableLanguages, compareLanguages, currentLanguage } from 'kalanfa/utils/i18n';
  ...
  export default {
    ...
    $trs: {
      showMoreLanguagesSelector: {
        ...
        context: 'An option to view more languages in which the Kalanfa interface is available.',
      },
    },
  };
