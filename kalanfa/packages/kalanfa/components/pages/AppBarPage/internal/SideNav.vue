        ...
        >
          ...
          >
            ...
            >
              ...
              <!-- Kalanfa footer logo -->
              <CoreLogo
                v-if="themeConfig.sideNav.showKalanfaFooterLogo"
                class="side-nav-scrollable-area-footer-logo"
              />
...
<script>
  ...
  import CoreMenu from 'kalanfa/components/CoreMenu';
  import CoreMenuOption from 'kalanfa/components/CoreMenu/CoreMenuOption';
  ...
  import Backdrop from 'kalanfa/components/Backdrop';
  import LanguageSwitcherModal from 'kalanfa/components/language-switcher/LanguageSwitcherModal';
  import urls from 'kalanfa/urls';
  import useNav from 'kalanfa/composables/useNav';
  ...
  import TooltipTour from 'kalanfa/components/onboarding/TooltipTour';
  import useTour from 'kalanfa/composables/useTour';
  ...
  export default {
    ...
    computed: {
      ...
      logoutUrl() {
        return urls['kalanfa:core:logout'] && urls['kalanfa:core:logout']();
      },
    },
    watch: {
      navShown(isShown) {
    ...
    $trs: {
      ...
      signOut: {
        message: 'Sign out',
        context:
          "Users can exit Kalanfa by selecting 'Sign out' from the user menu in the upper right corner.",
      },
    },
  };
