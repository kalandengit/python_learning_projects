...
import useNav, { useNavMock } from 'kalanfa/composables/useNav'; // eslint-disable-line
...
jest.mock('kalanfa/composables/useNav');
...
describe('side nav component', () => {
  ...
  describe('when on an SoUD or NOT', () => {
    describe('on an SoUD with learn-only device indicators', () => {
      ...
      /* Note that Facilty & Coach plugins are hackily disabled in their kalanfa_plugin
