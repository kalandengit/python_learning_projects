...
<script>
  ...
  import { UPDATE_MODAL_DISMISSED } from 'kalanfa/constants';
  import { currentLanguage, defaultLanguage } from 'kalanfa/utils/i18n';
  ...
  import { error, handleApiError } from 'kalanfa/utils/appError';
