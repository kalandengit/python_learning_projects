...
<script>
  ...
  import { error, clearError } from 'kalanfa/utils/appError';
  ...
  export default {
    ...
    $trs: {
      ...
      defaultErrorExitPrompt: {
        ...
        context:
          'If Kalanfa produces an unexpected error, this link appears which take the user back to the homepage.',
      },
      defaultErrorMessage: {
        message: 'We care about your experience on Kalanfa and are working hard to fix this issue',
        context:
      ...
      defaultErrorReportPrompt: {
        ...
        context:
          'Text that informs the user about how to report an error if they see one in Kalanfa.',
      },
      resourceNotFoundHeader: {
        message: 'Resource not found',
        context:
          'Error message that may appear if Kalanfa cannot find a learning resource such as a video or a quiz.',
      },
      resourceNotFoundMessage: {
        message: 'Sorry, that resource does not exist',
        context:
          'Message that appears when a user tries to access a learning resource that is not available in Kalanfa.',
      },
    },
  };
