...
<script>
  ...
  export default {
    ...
    computed: {
      forumLink() {
        return 'https://community.learningequality.org/c/support/kalanfa';
      },
      emailAddress() {
    ...
    $trs: {
      ...
      forumPrompt: {
        ...
        context:
          'If a user spots an error in Kalanfa, this prompt links through to the Kalanfa community forums where they can also report errors or search for similar issues.',
      },
      // reall long
      forumUseTips: {
        message:
          'Search the community forum to see if others encountered similar issues. If unable to find anything, paste the error details below into a new forum post so we can rectify the error in a future version of Kalanfa.',
        context:
          'If a user spots an error in Kalanfa, this text indicates that in Kalanfa community forums they can also report errors or search for similar issues.',
      },
      forumPostingTips: {
        message:
      ...
      emailPrompt: {
        ...
        context:
          'Users can send an email to the Kalanfa development team indicating details about an error if they see one.',
      },
      emailDescription: {
        message: "Contact the support team with your error details and we'll do our best to help.",
        context:
          'This is a message that a user sees if they provoke an error in Kalanfa. They can send an email to the Kalanfa development team indicating further details about the error.',
      },
      errorDetailsHeader: {
