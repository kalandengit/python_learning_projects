...
import * as METADATA from 'kalanfa/constants';
...
export const coreStrings = createTranslator('CommonCoreStrings', {
  ...
  closeAction: {
    message: 'Close',
    context: 'Closes some element in Kalanfa, like a window.',
  },
  confirmAction: {
    message: 'Confirm',
    context:
      "The 'Confirm' button will display when a user attempts to carry out a specific action in Kalanfa that needs confirmation. For example, they will be asked to confirm if they want to assign a coach to a class.",
  },
  continueAction: {
    message: 'Continue',
    context:
  ...
  editAction: {
    message: 'Edit',
    context:
      "Edit allows users to change some element in Kalanfa.\n\nFor example, a coach can use 'Edit' to rename their class or an admin can edit the name of their facility.",
  },
  editDetailsAction: {
    message: 'Edit details',
    context:
      "'Edit details' changes a set of information in Kalanfa.\n\nFor example, in a list of users, selecting OPTIONS > 'Edit details' allows a user to edit other users' information like their name, username or type.",
  },
  filter: {
    message: 'Filter',
    context:
      'The filter functionality allows users to find elements in Kalanfa more efficiently. For example, in a list of users the filter can be used to view users by permissions, user type or facility.',
  },
  finishAction: {
    message: 'Finish',
    context:
      "'Finish' in general completes an action that a user may be carrying out in Kalanfa.\n\nFor example, when a user creates an account, once they've completed all the information they would select the 'FINISH' button.",
  },
  goBackAction: {
    message: 'Go back',
    context:
      "Indicates going back to a previous step.\n\nFor example, when a user creates a quiz in Kalanfa using the quiz builder they can either 'CONTINUE' to the next phase of the builder or 'GO BACK'.\n\nIf you go back you exit the quiz builder and loose the resource selection.",
  },
  backAction: {
    message: 'Back',
    context:
  ...
  importAction: {
    message: 'Import',
    context:
      'Indicates importing something into Kalanfa, depending on the context can be a list of lessons, a single user, etc.',
  },
  registerAction: {
    message: 'Register',
    context: 'Register a facility to the Kalanfa Data Portal',
  },
  manageSyncAction: {
  ...
  saveAction: {
    message: 'Save',
    context:
      'Button which allows a user to save a specific state in Kalanfa.\n\nFor example, if a coach creates a new class they need to enter a name for the class and save that class name to continue.',
  },
  saveChangesAction: {
    message: 'Save changes',
    context:
      'When a user edits an entity en Kalanfa that changes some piece of information about it, they need to save those changes.',
  },
  saveAndFinishAction: {
    message: 'Save & finish',
    context:
      'When a user edits an entity in Kalanfa and no more changes are needed so we close the given view after that.',
  },
  saveAndClose: {
  ...
  selectAllOnPageAction: {
    ...
    context:
      "If admins have imported resources on one Kalanfa device, and want to make them available on another computer where Kalanfa is installed, they can export them either in full, or make a selection of the resources to be exported.\n\nThe 'Select all on page' option allows admins to export all the resources in bulk that are on that page rather than individually.",
  },
  showAction: {
    message: 'Show',
    context:
  ...
  updateAction: {
    message: 'Update',
    context:
      "If a user account has been created prior to version 0.13 of Kalanfa, the user will see a notification that they can update their profile to provide their birth year and gender. \n\nThe 'UPDATE' button allows them to provide this new information if they choose to do so.",
  },
  viewAll: {
    message: 'View all',
  ...
  viewAction: {
    message: 'View',
    context:
      'This text appears in several places in Kalanfa where users can see some specific information. For example, they can view changes when a public channel is updated, or view a list of notifications about quizzes.',
  },
  viewTasksAction: {
    message: 'View tasks',
    context:
      "In the Kalanfa Task Manager dashboard admins can view resource management tasks (import, export, deletion, update, etc.) and observe their progress.\n\nSelecting 'View task' will display more detail about the management task.",
  },
  removeFromBookmarks: {
  ...
  channelsLabel: {
    message: 'Channels',
    context:
      'Channels are collections of educational resources (video, audio, document files or interactive apps) prepared and organized by the channel curator for their use in Kalanfa.\n\nA learner will see a set of channels available to them when they first open Kalanfa.',
  },
  channelLabel: {
    message: 'Channel',
    context:
  ...
  classesLabel: {
    message: 'Classes',
    context:
      'In the classes section of Kalanfa users can view the list of all the classes in their facility, with the number of enrolled users for each class, and the coaches assigned.',
  },
  coachLabel: {
    message: 'Coach',
    context:
      'A coach is a specific type of user in Kalanfa who can manage  classes and learners. A coach can be either a class coach or a facility coach.',
  },
  coachesLabel: {
    message: 'Coaches',
    context:
  ...
  adminsLabel: {
    message: 'Admins',
    context: 'Admins are users with a specific role in Kalanfa with special permissions.',
  },
  superAdminsLabel: {
    message: 'Super admins',
    context: 'Super admins are users with a specific role in Kalanfa with special permissions.',
  },
  completedLabel: {
    message: 'Completed',
    context:
  ...
  deviceNameLabel: {
    message: 'Device name',
    context:
      'The device name indicates the name of the device where Kalanfa is running. Accessed in the Device > Info section.',
  },
  devicePermissionsLabel: {
    message: 'Device permissions',
    context:
      'A user can grant permission to another user to manage channels and resources in Kalanfa, that is to import, export and delete them from the device used.',
  },
  facilityCoachLabel: {
  ...
  facilitiesLabel: {
    message: 'Facilities',
    context:
      'Facilities are the centers of education which are managed in Kalanfa, such as a school. To manage facilities on a given device, a user must have super admin permissions.',
  },
  facilityName: {
  ...
  genderLabel: {
    message: 'Gender',
    context:
      "Gender is an option which a user can select in Kalanfa when they create another user.\n\nGender can be either 'Female', 'Male' or 'Not specified'.",
  },
  homeLabel: {
    message: 'Home',
    context:
  ...
  languageLabel: {
    message: 'Language',
    context:
      'Refers to the language that is used in a resource or in Kalanfa. For example, users can filter learning resources by language.',
  },
  learnerLabel: {
    message: 'Learner',
    context:
  ...
  libraryLabel: {
    message: 'Library',
    context:
      "The 'Library' section displays channels available on Kalanfa server, and allows learners to browse, explore and filter topics and resources on their own.",
  },
  loadingLabel: {
    message: 'Loading…',
  ...
  nameLabel: {
    message: 'Name',
    context: 'Might indicate the name of a resource in Kalanfa.',
  },
  noUsersExistLabel: {
  ...
  passwordLabel: {
    message: 'Password',
    context: "'Password' is a required field when you create an account as a user on Kalanfa.",
  },
  profileLabel: {
    message: 'Profile',
  ...
  searchLabel: {
    message: 'Search',
    context: 'Test used to indicate the Kalanfa search field.',
  },
  searchByKeyword: {
  ...
  cookiePolicy: {
    ...
    context:
      'The "Cookie policy" link displays on the \'cookie notification\' banner and on the left navigation bar.\n\nIt contains information about usage of cookies within online Kalanfa instances. It is also used as a title and heading on the page that describes this policy.',
  },
  userTypeLabel: {
    message: 'User type',
    context:
      "'User type' is used to define what kind of permissions the user has in Kalanfa.\n\n'User type' can be either Learner, Coach, Admin or Super admin.",
  },
  usernameLabel: {
    message: 'Username',
  ...
  usersLabel: {
    message: 'Users',
    context:
      'A user is any person who has access to a facility in Kalanfa. There are  four main types of users in Kalanfa: Learners, Coaches, Admins and Super admins.',
  },
  ...
  viewMoreAction: {
    message: 'View more',
    context:
      'This button appears in Kalanfa to indicate to users that there are more results available when they search for resources, for example.',
  },
  viewLessAction: {
    message: 'View less',
    context:
  ...
  sideNavLabel: {
    ...
    context:
      'Refers to the sidebar menu in Kalanfa that allows switching between main app sections like Learn, Coach, Facility, Device.',
  },
  contentActionsLabel: {
  ...
  guides: {
    message: 'Guides',
    context:
      'Category label in the Kalanfa resources library; refers to any guide-type material for teacher professional development.',
  },
  lessonPlans: {
    message: 'Lesson plans',
    context:
      'Category label in the Kalanfa resources library; refers to lesson planning materials for teachers.',
  },
  ...
  forBeginners: {
    ...
    context: 'Filter option and a label for the resources in the Kalanfa Library.',
  },
  toUseWithPeers: {
    message: 'To use with peers',
    context:
      "'Peers' in this context refers to classmates or other learners who are interacting with Kalanfa.",
  },
  toUseWithTeachers: {
  ...
  invalidCredentialsError: {
    ...
    context:
      "Error message a user sees if they've used the wrong username or password when they sign in to Kalanfa.",
  },
  defaultErrorMessage: {
  ...
  downloadedFailedWillRetry: {
    ...
    context:
      'Text that displays the status of a resource the user has downloaded when the download has failed, but Kalanfa is able to automatically try the download again.',
  },
  downloadedFailedCanNotRetry: {
    message: 'Download failed. Unable to retry.',
    context:
      'Text that displays the status of a resource the user has downloaded when the download has failed, and Kalanfa is not able to automatically try the download again.',
  },
  deviceDisconnected: {
  ...
  userDevicesUsingIE11: {
    message: 'Some users seem to have accessed Kalanfa via Internet Explorer 11',
    context:
  ...
  browserSupportDroppedIE11: {
    message:
      'Please note that support for this browser has been dropped.  We recommend installing other browsers, such as Mozilla Firefox or Google Chrome, in order to continue working with Kalanfa.',
    context:
      'Displayed to users of kalanfa where one or more devices on the network are using Internet Explorer 11, as part of a message encouraging the user to upgrade.',
  },
  ...
  changeLanguageOption: {
    ...
    context: "Option to change the Kalanfa interface language on the  'Change language' screen.",
  },
  ...
  neverPayDescription: {
    message: 'Kalanfa and its library will always be free of charge',
    context: '',
  },
  ...
  whatLanguageDescription: {
    message: 'Kalanfa will recommend materials in the language you select.',
    context: '',
  },
  ...
  learningFacilityDescription: {
    message:
      'A learning facility represents the location where you are installing Kalanfa, such as a school, training center, or your home.',
    context: '',
  },
  ...
  addLearningMaterialsDescription: {
    message:
      'Choose materials to use on your device. You will also be able to add more whenever you are connected to the internet or there are other Kalanfas around you.',
    context: '',
  },
  yourLibrary: {
 ...
 *
 * - Misspelling of the key in coreStrings but a kalanfa-constant used to access it is
 ...
 * ID keys generated in the kalanfa-constants library to their appropriate translations
 * if available.
