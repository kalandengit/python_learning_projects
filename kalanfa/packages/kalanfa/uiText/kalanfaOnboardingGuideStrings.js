...
export const kalanfaOnboardingGuideStrings = createTranslator('kalanfaOnboardingGuideStrings', {
  ...
  sideNavigationIconDecription: {
    message: 'Open this menu to find other ways to use Kalanfa.',
...
export function onboardingGuideString(...args) {
  return kalanfaOnboardingGuideStrings.$tr(...args);
}
