...
<script>
  ...
  import LearnerPasswordCard from 'kalanfa-common/components/LearnerPasswordCard';
  ...
  export default {
    ...
    computed: {
      pageTitle() {
        return [this.allPasswordsHeader$(), this.className, this.facilityName, this.kalanfaLabel$()]
          .filter(Boolean)
          .join(' - ');
      },
      cardStyle() {
