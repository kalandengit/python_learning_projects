  ...
  export default {
    ...
    $trs: {
      confirmPasswordLabel: {
        ...
        context:
          "This text displays on the 'Create an account' form when a new user signs up for Kalanfa. A new users needs to confirm their password  in the 'Re-enter password' field to make sure it matches the 'Password' entered in the previous field.",
      },
      errorNotMatching: {
