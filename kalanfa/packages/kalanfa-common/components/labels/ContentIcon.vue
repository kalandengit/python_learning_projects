...
<script>
  ...
  import { validateContentNodeKind } from 'kalanfa/utils/validators';
  import { ContentNodeKinds, USER } from 'kalanfa/constants';
  import UiIcon from 'kalanfa-design-system/lib/keen/UiIcon';
  ...
  export default {
    ...
    $trs: {
      ...
      channel: {
        message: 'Channel',
        context:
          'A channel is a set of learning resources that can be imported to and exported from Kalanfa. It is often curated in order to achieve certain pre-defined learning objectives. Channels are originally created within Kalanfa Studio.',
      },
      exercise: {
        message: 'Exercise',
        context:
      ...
      video: {
        message: 'Video',
        context:
          'A video is a type of learning resource that is available in Kalanfa. Other types of resources are documents, exercises or slideshows.',
      },
      audio: {
        message: 'Audio',
        context:
          'Audio is a type of education material available to learners in Kalanfa. Other types of material could be exercises, videos or document files.',
      },
      document: {
        message: 'Document',
        context:
          'A document is a type of learning resource that is available in Kalanfa. Other types of resources are videos, exercises or slideshows.',
      },
      html5: {
        message: 'App',
        context:
          'In Kalanfa, an app is a certain kind of learning resource. Specifically, apps are generally self-contained, interactive HTML and Javascript applications.',
      },
      exam: {
        message: 'Quiz',
        context:
      ...
      slideshow: {
        message: 'Slideshow',
        context:
          'A slideshow is a type of learning resource that is available in Kalanfa. Slideshows contain slides and you navigate through them using arrows. Other types of resources are videos, exercises or documents.',
      },
    },
  };
