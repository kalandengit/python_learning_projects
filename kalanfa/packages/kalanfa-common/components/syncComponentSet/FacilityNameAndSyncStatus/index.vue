...
<script>
  ...
  import taskStrings from 'kalanfa-common/uiText/tasks';
  ...
  export default {
    ...
    $trs: {
      registeredAlready: {
        message: 'Registered to `Kalanfa Data Portal`',
        context:
          'If a Kalanfa facility is part of a larger organization that tracks data on the Kalanfa Data Portal,  it can be registered to the Kalanfa Data Portal.\n\nThis text indicates that the facility has been registered to the Data Portal.',
      },
      neverSynced: {
