...
<script>
  ...
  export default {
    ...
    $trs: {
      dataPortalLabel: {
        message: 'Kalanfa Data Portal (online)',
        context:
          'Label on radio button for Kalanfa Data Portal, which requires an internet connection',
      },
      dataPortalDescription: {
        message: 'Sync to Kalanfa Data Portal if your facility is registered',
      ...
      localNetworkDescription: {
        message:
          'Sync facility data with another Kalanfa server on your local network or the internet',
