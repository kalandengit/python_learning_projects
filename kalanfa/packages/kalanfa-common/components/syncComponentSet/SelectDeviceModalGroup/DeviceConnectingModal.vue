  ...
  export default {
      ...
      connectionFailureMessage() {
        ...
        switch (connectionStatus) {
          ...
          case 'InvalidResponse':
            return this.$tr('deviceIsNotKalanfa', { name: this.deviceName });
          default:
    ...
    $trs: {
      connectingTo: {
        ...
        context:
          "Shown while testing the connection to a network device, Kalanfa Studio, or Kalanfa Data Portal, as specified by 'name'",
      },
      connectionFailure: {
        message:
      ...
      deviceIsNotKalanfa: {
        message:
          "Another program is running at the same network address as '{name}'. Please close the program, ensure Kalanfa is running on that device, and try again.",
        context:
          "Error message when testing the connection to the network device specified by 'name' fails for this reason",
      },
      connectionTimedOut: {
      ...
      internetDisconnected: {
        ...
        context:
          "Error message when testing the connection to a network device fails because Kalanfa isn't connected to the internet and the device address is on the internet",
      },
      /* eslint-disable kalanfa/vue-no-unused-translations */
      connectionFailureKalanfaVersion: {
        message:
          "Unable to connect to '{name}'. Please update both devices to Kalanfa version {version_number} or higher.",
        context:
          "Error message when testing the connection to the network device specified by 'name' fails for this reason",
      },
