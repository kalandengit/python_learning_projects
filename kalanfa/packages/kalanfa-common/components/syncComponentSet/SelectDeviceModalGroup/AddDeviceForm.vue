  ...
  export default {
    ...
    $trs: {
      addressDesc: {
        ...
        context:
          'This text appears as a helper for admins in the Device > Facilities section so they know what the format of the network address should be like.\n\nUsers can import resources from a different device running Kalanfa in their same local network, or from a Kalanfa server hosted outside their LAN, provided they know its exact IP address.',
      },
      addressLabel: {
        message: 'Full network address',
        context:
          'This is the field where an admin enters the network address of a different device running Kalanfa. This can be either in their same local network, or from a Kalanfa server hosted outside their LAN.\n\nThe admin adds this network address in the Device > Facilities section.',
      },
      addressPlaceholder: {
      ...
      errorCouldNotConnect: {
        ...
        context:
          "This is an error message that an admin will see when Kalanfa can't connect to another device when trying to import resources.",
      },
      errorInvalidAddress: {
      ...
      tryingToConnect: {
        ...
        context:
          'Progress message an admin sees when Kalanfa is attempting to connect to a device.',
      },
    },
  };
