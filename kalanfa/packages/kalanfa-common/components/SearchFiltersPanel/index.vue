...
<script>
  ...
  // - kalanfa/plugins/learn/frontend/views/LibraryPage/index.vue
  //   in https://github.com/learningequality/kalanfa/blob/develop/kalanfa/plugins/learn/frontend/views/LibraryPage/index.vue#L238-L251
  // - kalanfa/plugins/learn/frontend/views/TopicsPage/index.vue
  //   in https://github.com/learningequality/kalanfa/blob/develop/kalanfa/plugins/learn/frontend/views/TopicsPage/index.vue#L366-L378
  //

  import { NoCategories } from 'kalanfa/constants';
  import commonCoreStrings from 'kalanfa/uiText/commonCoreStrings';
  import { searchAndFilterStrings } from 'kalanfa-common/strings/searchAndFilterStrings';
  import useKResponsiveWindow from 'kalanfa-design-system/lib/composables/useKResponsiveWindow';
  import { ref } from 'vue';
  import { injectBaseSearch } from 'kalanfa-common/composables/useBaseSearch';
