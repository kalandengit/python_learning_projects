...
<script>
  ...
  import InteractionList from 'kalanfa-common/components/quizzes/InteractionList';
  import find from 'lodash/find';
  import MultiPaneLayout from 'kalanfa-common/components/MultiPaneLayout';
  ...
  import MasteryLogResource from 'kalanfa-common/apiResources/MasteryLogResource';
  import useNow from 'kalanfa/composables/useNow';
  import { annotateSections } from 'kalanfa-common/quizzes/utils';
  import MissingResourceAlert from 'kalanfa-common/components/MissingResourceAlert';
  import { displaySectionTitle } from 'kalanfa-common/strings/enhancedQuizManagementStrings';
