...
export const impactStoryStrings = createTranslator('ImpactStoryBanner', {
  title: {
    message: 'How has Kalanfa made an impact on your teachers or learners?',
    context: 'Heading on the impact-story banner.',
  },
  message: {
    message:
      "We're collecting before-and-after moments of teachers or learners using Kalanfa. " +
      "Help us inspire others by sharing the impact Kalanfa has made on an individual's journey.",
  ...
  whatsappIntroText: {
    message: `Hi! I'd like to share a Kalanfa story.
