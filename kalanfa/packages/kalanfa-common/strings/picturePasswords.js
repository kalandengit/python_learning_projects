...
export const picturePasswordStrings = createTranslator('PicturePasswordStrings', {
  ...
  formAriaLabel: {
    message: 'Select 3 pictures below to sign in to Kalanfa',
    context:
  ...
  picturePasswordWillBeAssigned: {
    message: 'Kalanfa will automatically assign a picture password after the user is created.',
    context:
  ...
  picturePasswordInfoBody: {
    message:
      'Learners sign in by selecting a 3-picture sequence unique to their account. Each sequence is auto-generated and assigned by Kalanfa and cannot be changed. This feature is only available in facilities with fewer than 1,300 learners.',
  ...
  picturePasswordAssignedDescription: {
    message:
      'Remember these pictures and write them down if you need to. You will need them to sign in to Kalanfa in the future.',
    context:
