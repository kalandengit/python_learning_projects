...
export const searchAndFilterStrings = createTranslator('SearchAndFilterStrings', {
  ...
  warningForQuizFromOldKalanfa: {
    message:
      'This quiz was created using an older version of Kalanfa and cannot be edited directly. Create a copy of it to edit the resources.',
    context: 'Warning message for quizzes created in an older version of Kalanfa.',
  },
  removeResourceLabel: {
