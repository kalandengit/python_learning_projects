...
import { getTaskString } from 'kalanfa-common/uiText/tasks';
import bytesForHumans from 'kalanfa/uiText/bytesForHumans';

export const TaskTypes = {
  REMOTECHANNELIMPORT: 'kalanfa.core.content.tasks.remotechannelimport',
  REMOTECONTENTIMPORT: 'kalanfa.core.content.tasks.remotecontentimport',
  REMOTEIMPORT: 'kalanfa.core.content.tasks.remoteimport',
  DISKCHANNELIMPORT: 'kalanfa.core.content.tasks.diskchannelimport',
  DISKCONTENTIMPORT: 'kalanfa.core.content.tasks.diskcontentimport',
  DISKIMPORT: 'kalanfa.core.content.tasks.diskimport',
  DISKCONTENTEXPORT: 'kalanfa.core.content.tasks.diskcontentexport',
  DISKEXPORT: 'kalanfa.core.content.tasks.diskexport',
  DELETECHANNEL: 'kalanfa.core.content.tasks.deletechannel',
  UPDATECHANNEL: 'kalanfa.core.content.tasks.updatechannel',
  REMOTECHANNELDIFFSTATS: 'kalanfa.core.content.tasks.remotechanneldiffstats',
  LOCALCHANNELDIFFSTATS: 'kalanfa.core.content.tasks.localchanneldiffstats',
  SYNCDATAPORTAL: 'kalanfa.core.auth.tasks.dataportalsync',
  SYNCPEERFULL: 'kalanfa.core.auth.tasks.peerfacilitysync',
  SYNCPEERPULL: 'kalanfa.core.auth.tasks.peerfacilityimport',
  DELETEFACILITY: 'kalanfa.core.auth.tasks.deletefacility',
  EXPORTSESSIONLOGCSV: 'kalanfa.core.logger.tasks.exportsessionlogcsv',
  EXPORTSUMMARYLOGCSV: 'kalanfa.core.logger.tasks.exportsummarylogcsv',
  IMPORTUSERSFROMCSV: 'kalanfa.core.auth.tasks.importusersfromcsv',
  EXPORTUSERSTOCSV: 'kalanfa.core.auth.tasks.exportuserstocsv',
  IMPORTLODUSER: 'kalanfa.core.auth.tasks.peeruserimport',
  PROVISIONDEVICE: 'kalanfa.core.device.tasks.provisiondevice',
  DEPROVISIONDEVICE: 'kalanfa.core.device.tasks.deprovisiondevice',
};
...
export function syncFacilityTaskDisplayInfo(task) {
  ...
  if (task.type === TaskTypes.SYNCDATAPORTAL) {
    deviceNameMsg = 'Kalanfa Data Portal';
