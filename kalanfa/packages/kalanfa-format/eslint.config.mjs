...
import pluginKalanfa from 'eslint-plugin-kalanfa';
...
export default [
  ...
  {
    rules: {
      // Kalanfa design-system components that always render accessible text content
      ...
      // Kalanfa intentionally uses autofocus for accessibility (focus management on modal
  ...
  // JSDoc linting for .js and .vue files
  {
    ...
    rules: {
      ...
      // `@affects` documents side-effects on outer state; used widely in Kalanfa composables.
      'jsdoc/check-tag-names': [ERROR, { definedTags: ['affects'] }],
    },
  },
  {
    plugins: {
      kalanfa: pluginKalanfa,
      jest: pluginJest,
      n: pluginN,
    ...
    rules: {
      ...
      // with our vendored version that implements our Kalanfa
      ...
      'import-x/order': [
        ...
        {
          pathGroups: [
            { pattern: 'kalanfa', group: 'external' },
            { pattern: 'kalanfa/**', group: 'external' },
            { pattern: 'kalanfa-*', group: 'external' },
            { pattern: 'kalanfa-*/**', group: 'external' },
          ],
      ...
      // Custom vue rules
      'kalanfa/vue-no-unused-vuex-properties': ERROR,
      'kalanfa/vue-no-unused-vuex-methods': ERROR,
      'kalanfa/vue-watch-no-string': ERROR,
      'kalanfa/vue-no-unused-translations': ERROR,
      'kalanfa/vue-no-undefined-string-uses': ERROR,
      'kalanfa/no-undefined-translator-keys': ERROR,
      'kalanfa/vue-string-objects-formatting': ERROR,
      'kalanfa/vue-component-block-padding': ERROR,
      'kalanfa/vue-component-block-tag-newline': ERROR,
      'kalanfa/vue-component-require-img-src': ERROR,
      'kalanfa/vue-component-class-name-casing': ERROR,
      'kalanfa/vue-component-no-duplicate-ids': ERROR,
  ...
  // Override: spec files get jest globals
  {
    ...
    rules: {
      'kalanfa/tests-no-hardcoded-strings': ERROR,
      'kalanfa/tests-no-stubs': ERROR,
    },
  },
