/**
 * This class offers an API interface for interacting directly with the Kalanfa app
...
/**
 * Type definition for Theme options. Concrete properties TBD; tracked at the embedding-app
 * spec layer rather than in the sandbox shim.
...
export default class Kalanfa extends BaseShim {
  constructor(mediator) {
    super(mediator);
    this.data = {};
    this.nameSpace = 'kalanfa';
  ...
  __setShimInterface() {
    ...
    class Shim {
      ...
      /*
       * Method to query next page of contentnodes from Kalanfa and return
       * an array
      ...
      getVersion() {
        return self.mediator.sendMessageAwaitReply({
          event: events.DATAREQUESTED,
          data: { dataType: DataTypes.KALANFAVERSION },
          nameSpace,
        });
      }

      /*
       * Method to query channel metadata from Kalanfa
      ...
      /*
       * Method to query channel filter options from Kalanfa
      ...
      /*
       * Method to query random contentnodes from Kalanfa and return an array
